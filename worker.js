...
<nav class="tab-nav">
  ...
  <button class="tab-btn" onclick="switchTab('changelog', this)" style="margin-left:auto;font-size:11px;opacity:0.75;">📋 Histórico de Alterações</button>
      <button class="tab-btn" id="btn-anderson" onclick="switchTab('anderson',this)" style="display:none;">👤 Anderson</button>
      ...
      <button class="tab-btn" id="btn-pedro" onclick="switchTab('pedro',this)" style="display:none;">👤 Meu Painel</button>
      <a href="/logout" style="margin-left:auto;display:flex;align-items:center;gap:6px;padding:6px 14px;border-radius:8px;border:1px solid #e5e7eb;background:#fff;color:#374151;font-size:12px;font-weight:600;text-decoration:none;" onmouseover="this.style.background='#f9fafb'" onmouseout="this.style.background='#fff'"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>Sair</a>
</nav>
<script>
...
<div class="page">
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:28px;">
    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-top:3px solid #2563eb;border-radius:12px;padding:18px 20px;">
      ...
      <div style="font-size:28px;font-weight:900;color:#2563eb;line-height:1;">R$ 7.210.187,20</div>
      <div style="font-size:12px;color:#6b7280;margin-top:6px;">134 contratos ativos</div>
    </div>
    ...
    <div style="background:#fef2f2;border:1px solid #fecaca;border-top:3px solid #dc2626;border-radius:12px;padding:18px 20px;">
      ...
      <div style="font-size:28px;font-weight:900;color:#dc2626;line-height:1;">−R$ 274.259,93</div>
      <div style="font-size:12px;color:#b91c1c;margin-top:6px;font-weight:600;">3.7% vs início do ano</div>
    </div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin-bottom:28px;">
    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:20px 24px;">
      ...
      <div style="font-size:32px;font-weight:900;color:#374151;line-height:1;">R$ 536.822,90</div>
      <div style="font-size:12px;color:#6b7280;margin-top:6px;">S2M7 · aba atual</div>
    </div>

    <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:12px;padding:20px 24px;">
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#2563eb;margin-bottom:10px;">📈 MRR Ajustado (Jun/2026)</div>
      <div style="font-size:32px;font-weight:900;color:#2563eb;line-height:1;">R$ 536.528,66</div>
    ...
    <div style="background:#fef2f2;border:1px solid #fecaca;border-radius:12px;padding:20px 24px;">
      ...
      <div style="font-size:32px;font-weight:900;color:#dc2626;line-height:1;">−R$ 294,24</div>
      <div style="font-size:12px;color:#b91c1c;margin-top:6px;font-weight:600;">-0.05% vs baseline</div>
    </div>
  ...
  <div style="margin-bottom:28px;">
    ...
    <div style="background:#f8fafc;border:1px solid #e5e7eb;border-radius:10px;padding:10px 16px;margin-bottom:10px;font-size:12px;color:#6b7280;">
      <strong>Fórmula:</strong> MRR Ajustado = MRR Baseline R$ 536.822,90 + MRR de Projetos Aprovados (≥ Jan/2026) − Cancelamentos de MRR − Reduções de MRR
    </div>
    <div style="overflow-x:auto;border:1px solid #bfdbfe;border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;min-width:700px;">
        ...
        <tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jan/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#059669;font-weight:600;">+R$ 14.366,00</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#dc2626;font-weight:700;">−R$ 11.469,00</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d97706;font-weight:700;">−R$ 6.318,56</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 533.401,34</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#dc2626;font-weight:700;">−R$ 3.421,56</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Fev/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#059669;font-weight:600;">+R$ 3.704,12</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#dc2626;font-weight:700;">−R$ 265,80</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d97706;font-weight:700;">−R$ 2.665,32</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 534.174,34</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#059669;font-weight:700;">+R$ 773,00</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Mar/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#059669;font-weight:600;">+R$ 6.422,00</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d97706;font-weight:700;">−R$ 1.657,71</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 538.938,63</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#059669;font-weight:700;">+R$ 4.764,29</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Abr/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#059669;font-weight:600;">+R$ 4.812,00</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#dc2626;font-weight:700;">−R$ 9.037,86</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d97706;font-weight:700;">−R$ 573,00</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 534.139,77</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#dc2626;font-weight:700;">−R$ 4.798,86</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Mai/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#059669;font-weight:600;">+R$ 283,93</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d97706;font-weight:700;">−R$ 1.146,00</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 533.277,70</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#dc2626;font-weight:700;">−R$ 862,07</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jun/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#059669;font-weight:600;">+R$ 6.435,01</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#dc2626;font-weight:700;">−R$ 618,05</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d97706;font-weight:700;">−R$ 2.566,00</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 536.528,66</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#059669;font-weight:700;">+R$ 3.250,96</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jul/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 536.528,66</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Ago/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 536.528,66</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Set/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 536.528,66</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Out/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 536.528,66</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Nov/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 536.528,66</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Dez/26</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 536.528,66</td><td style="padding:10px 16px;text-align:right;font-size:13px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;"><td style="padding:10px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Baseline</td><td colspan="3" style="padding:10px 16px;text-align:right;font-size:11px;color:#6b7280;">baseline: R$ 536.822,90</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:800;color:#2563eb;">R$ 536.528,66</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#dc2626;font-weight:800;">−R$ 294,24</span></td></tr></tbody>
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:20px;">
    ...
    <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-top:3px solid #059669;border-radius:12px;padding:18px 20px;">
      ...
      <div style="font-size:34px;font-weight:900;color:#059669;line-height:1;">39</div>
      <div style="font-size:12px;color:#065f46;margin-top:6px;font-weight:600;">R$ 625.641,06 · aprovados ≥ jan/26</div>
    </div>
    ...
    <div style="background:#fff;border:1px solid #e9d5ff;border-top:3px solid #7c3aed;border-radius:12px;padding:18px 20px;">
      ...
      <div style="font-size:34px;font-weight:900;color:#7c3aed;line-height:1;">R$ 36.023,06</div>
    ...
    <div style="background:#fff;border:1px solid #bfdbfe;border-top:3px solid #0891b2;border-radius:12px;padding:18px 20px;">
      ...
      <div style="font-size:34px;font-weight:900;color:#0891b2;line-height:1;">R$ 261.399,65</div>
  ...
  <div style="display:grid;grid-template-columns:1fr 2fr;gap:16px;margin-bottom:28px;">
    ...
    <div>
      ...
      <div style="border:1px solid #bbf7d0;border-radius:12px;overflow:hidden;">
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:12px 20px;font-size:14px;font-weight:700;color:#111827;">Jan/26</td><td style="padding:12px 20px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:13px;font-weight:700;padding:3px 12px;border-radius:99px;">8</span></td><td style="padding:12px 20px;text-align:right;font-size:14px;font-weight:700;color:#111827;">R$ 280.282,60</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:12px 20px;font-size:14px;font-weight:700;color:#111827;">Fev/26</td><td style="padding:12px 20px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:13px;font-weight:700;padding:3px 12px;border-radius:99px;">6</span></td><td style="padding:12px 20px;text-align:right;font-size:14px;font-weight:700;color:#111827;">R$ 82.576,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:12px 20px;font-size:14px;font-weight:700;color:#111827;">Mar/26</td><td style="padding:12px 20px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:13px;font-weight:700;padding:3px 12px;border-radius:99px;">11</span></td><td style="padding:12px 20px;text-align:right;font-size:14px;font-weight:700;color:#111827;">R$ 107.138,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:12px 20px;font-size:14px;font-weight:700;color:#111827;">Abr/26</td><td style="padding:12px 20px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:13px;font-weight:700;padding:3px 12px;border-radius:99px;">6</span></td><td style="padding:12px 20px;text-align:right;font-size:14px;font-weight:700;color:#111827;">R$ 50.992,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:12px 20px;font-size:14px;font-weight:700;color:#111827;">Mai/26</td><td style="padding:12px 20px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:13px;font-weight:700;padding:3px 12px;border-radius:99px;">3</span></td><td style="padding:12px 20px;text-align:right;font-size:14px;font-weight:700;color:#111827;">R$ 4.883,93</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:12px 20px;font-size:14px;font-weight:700;color:#111827;">Jun/26</td><td style="padding:12px 20px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:13px;font-weight:700;padding:3px 12px;border-radius:99px;">4</span></td><td style="padding:12px 20px;text-align:right;font-size:14px;font-weight:700;color:#111827;">R$ 98.351,53</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:12px 20px;font-size:14px;font-weight:700;color:#111827;">Jul/26</td><td style="padding:12px 20px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:13px;font-weight:700;padding:3px 12px;border-radius:99px;">1</span></td><td style="padding:12px 20px;text-align:right;font-size:14px;font-weight:700;color:#111827;">R$ 1.417,00</td></tr><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;"><td style="padding:12px 20px;font-size:12px;font-weight:800;text-transform:uppercase;color:#059669;">Total</td><td style="padding:12px 20px;text-align:center;font-size:14px;font-weight:800;color:#059669;">39</td><td style="padding:12px 20px;text-align:right;font-size:14px;font-weight:800;color:#111827;">R$ 625.641,06</td></tr></tbody>
        </table>
      </div>
    </div>
    ...
    <!-- Detalhe -->
    <div>
      <div class="p26-section-label">Detalhe · 39 projetos · ordenado por data de aprovação</div>
      <div style="overflow-y:auto;max-height:340px;border:1px solid #e9d5ff;border-radius:12px;">
        <table style="width:100%;border-collapse:collapse;min-width:500px;">
          ...
          <tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117439</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Trt Da 4ª Região</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/07/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.417,60</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117451</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Task Sistemas</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 4.190,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 19.760,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117191</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">SERILON BRASIL</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 2.681,47</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116985</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">NETCENTER INFORMATICA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 1.330,73</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 9.120,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115261</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">LUXCEL MAXLOG</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 914,28</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 3.040,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117118</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">STEFANINI</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/05/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 183,93</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.103,58</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116804</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/05/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 100,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 100,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116356</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">AUXILIADORA PREDIAL</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/05/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 3.500,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116763</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 400,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116700</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 100,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 100,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116667</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116531</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 100,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.200,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116022</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">IRANI PAPEL E EMBALAGEM S.A</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 16.720,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115875</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">CASTROLANDA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 3.912,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116595</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 5.122,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116388</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116294</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 200,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116138</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">AUXILIADORA PREDIAL</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.140,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116129</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116095</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 200,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116081</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">NETCENTER INFORMATICA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 3.800,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116040</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115812</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">BRASTORAGE - THINK</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.140,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115715</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">CORPFLEX INFORMATICA LTDA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 992,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-113976</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">SERVIÇO SOCIAL DO COMÉRCIO - ADMINISTRAÇÃO REGIONAL NO ESTADO DO RIO DE JANEIRO (SESC/ ARRJ)</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 79.344,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115653</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Pedro</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115586</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.520,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114660</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">M.L.GOMES</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 6.080,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114632</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Novvacore Jr & Js - Telecom LTDA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 3.588,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114138</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">TORRA TORRA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 116,12</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 760,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-111340</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRUKI</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115316</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115262</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">INTERCITY</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 76.721,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115157</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">STEFANINI</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 5.240,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114662</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">IRANI PAPEL E EMBALAGEM S.A</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114581</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">SOLVI PARTICIPAÇÕES</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 6.576,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114454</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">KICALDO</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 760,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-113067</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">EBM Incorporações S/A</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 1.450,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 30.400,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-112107</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">SABEMI SEGURADORA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 800,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;"><td colspan="3" style="padding:12px 16px;font-size:11px;font-weight:700;text-transform:uppercase;color:#059669;">Total · 39 projetos</td><td style="padding:12px 16px;text-align:right;font-size:13px;font-weight:800;color:#111827;">R$ 625.641,06</td><td style="padding:12px 16px;text-align:right;font-size:13px;font-weight:800;color:#7c3aed;">R$ 36.023,06</td><td style="padding:12px 16px;text-align:right;font-size:13px;font-weight:800;color:#0891b2;">R$ 261.399,65</td></tr></tbody>
        </table>
      </div>
    </div>
  </div>
  ...
  <!-- HEADER -->
  <div class="p26-header" style="margin-bottom:28px;">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:10px;">
      ...
      <span style="background:#fef9c3;color:#92400e;font-size:12px;font-weight:700;padding:4px 14px;border-radius:99px;">⚡ 10 contratos em atraso</span>
    </div>
  </div>
  ...
  <div class="p26-kpi-row" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:40px;">
    <div class="p26-kpi" style="--kpi-accent:#7c3aed">
      ...
      <div class="p26-kpi-sub">2 neg · 0 parados +90d</div>
    </div>
    ...
    <div class="p26-kpi" style="--kpi-accent:#059669">
      ...
      <div class="p26-kpi-number" style="color:#059669">3</div>
      <div class="p26-kpi-sub">R$ 28K · MRR R$ 2K</div>
    </div>
    <div class="p26-kpi" style="--kpi-accent:#7c3aed">
      <div class="p26-kpi-label">Carteira Contratos</div>
      <div class="p26-kpi-number" style="color:#7c3aed">52</div>
      <div class="p26-kpi-sub">MRR R$ 58K · 10 em atraso</div>
    </div>
  </div>
  <!-- PIPELINE CLIENTES -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">📋 Pipeline — Projetos Ativos (31)</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#7c3aed;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📦 Projetos Clientes</div>
      <div style="font-size:28px;font-weight:900;color:#7c3aed;line-height:1;margin-bottom:10px;">31</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total em carteira</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 282K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Em negociação</span><span style="font-size:11px;font-weight:700;color:#374151;">2 · R$ 103K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +90 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +180 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#0284c7;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📨 Proj. Enviados</div>
      <div style="font-size:28px;font-weight:900;color:#0284c7;line-height:1;margin-bottom:10px;">20</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT aguardando</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 173K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Ticket médio</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 9K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Mais antigo (dias)</span><span style="font-size:11px;font-weight:700;color:#374151;">0d</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#374151;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📊 Por Etapa</div>
      <div style="font-size:28px;font-weight:900;color:#374151;line-height:1;margin-bottom:10px;"></div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Projeto Enviado</span><span style="font-size:11px;font-weight:700;color:#374151;">20 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Qualificação</span><span style="font-size:11px;font-weight:700;color:#374151;">5 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Elaboração de Projeto</span><span style="font-size:11px;font-weight:700;color:#374151;">4 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Negociação</span><span style="font-size:11px;font-weight:700;color:#374151;">2 projetos</span></div>
    </div>
    </div>
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          <th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:70px;">Age</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:110px;">NP</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Cliente</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Etapa</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">VT</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Abertura</th>
        </tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116087</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SANTA CASA DE MISERICÓRDIA DE PORTO ALEGRE</td>
          <td style="padding:11px 16px;"><span style="background:#fef3c7;color:#d97706;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Negociação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 73.587,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-111370</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SANTA CASA DE MISERICORDIA DA BAHIA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 42.522,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115925</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">KleyHertz Farmacêutica</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 35.520,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115335</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CPA</td>
          <td style="padding:11px 16px;"><span style="background:#fef3c7;color:#d97706;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Negociação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 29.454,42</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-113547</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TIMAC AGRO</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 24.192,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115788</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">USINA SAO JOSE DA ESTIVA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 15.664,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-113863</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ROYAL PALM HOTELS & RESORTS (GRUPO ARCEL)</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 12.872,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114241</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">PANATLANTICA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.400,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116911</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TENDA ATACADO</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 10.260,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114405</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">S3CURITY</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.600,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114151</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SERVIX</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 6.144,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-113199</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">S3CURITY</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 5.700,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116759</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SANTA CASA DE MISERICÓRDIA DE PORTO ALEGRE</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.040,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116758</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SANTA CASA DE MISERICÓRDIA DE PORTO ALEGRE</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 1.520,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116385</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CONNECTION SEGURANÇA E GESTÃO DE TI</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 1.200,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114776</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">IMPORTADORA BAGE S/A</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 1.140,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117495</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATP</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117480</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATP</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117479</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATRIO HOTÉIS</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117359</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATP</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117358</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATP</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117313</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">RBS - Televisão Gaúcha SA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117188</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATRIO HOTÉIS</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117185</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GRUPO MARINGÁ</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117074</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATRIO HOTÉIS</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117054</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SERILON BRASIL</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116721</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TORRA TORRA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">115730</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">IMPORTADORA BAGE S/A</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115517</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">IMPORTADORA BAGE S/A</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115156</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TORRA TORRA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-113281</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LUXCEL MAXLOG</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr></tbody>
        <tfoot><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;">
          <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#059669;">Total · 31 projetos</td>
          <td></td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 281.815,42</td>
          <td></td>
        </tr></tfoot>
      </table>
    </div>
  ...
  <!-- LEADS -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">🎯 Leads em Prospecção (11)</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#6b7280;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">🎯 Leads Ativos</div>
      <div style="font-size:28px;font-weight:900;color:#6b7280;line-height:1;margin-bottom:10px;">11</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 96K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Ticket médio</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 9K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +90 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +180 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#d97706;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">💬 Em Negociação</div>
      <div style="font-size:28px;font-weight:900;color:#d97706;line-height:1;margin-bottom:10px;">0</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT em negociação</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div>
    </div>
      <div></div>
    </div>
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          <th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:70px;">Age</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:110px;">NP</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Lead</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Etapa</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">VT</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Abertura</th>
        </tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-115250</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">RRP ENERGIA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 67.387,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116728</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Novus Automation</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 17.464,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-114308</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SPRINGER CARRIER (MIDEA)</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 10.776,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-117447</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">HUB4IT TECNOLOGIA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116600</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Enops Engenharia S.A.</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116428</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Costão do Santinho Resort & SPA.</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116426</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Attus</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116425</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">VaBene Confeitaria e Sorveteria</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116424</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AFECC - Hospital Santa Rita de Cássia</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116420</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Essencis MG</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-115242</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Brasdiesel SA Comercial e Importadora</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr></tbody>
        <tfoot><tr style="background:#f8fafc;border-top:2px solid #e5e7eb;">
          <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#374151;">Total · 11 leads</td>
          <td></td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 95.627,00</td>
          <td></td>
        </tr></tfoot>
      </table>
    </div>
  ...
  <!-- CONTRATOS -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">🔄 Contratos em Renovação (52)</div>
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#059669;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">✅ Renovados</div>
      <div style="font-size:28px;font-weight:900;color:#059669;line-height:1;margin-bottom:10px;">9</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC renovado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 130K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR renovado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 8K</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#92400e;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">⚡ Em Análise + PF</div>
      <div style="font-size:28px;font-weight:900;color:#92400e;line-height:1;margin-bottom:10px;">4</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Em análise cliente</span><span style="font-size:11px;font-weight:700;color:#374151;">3</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Processo Financeiro</span><span style="font-size:11px;font-weight:700;color:#374151;">1</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC em risco</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 53K</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#7c3aed;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📋 Análise Req.</div>
      <div style="font-size:28px;font-weight:900;color:#7c3aed;line-height:1;margin-bottom:10px;">39</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 840K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 48K</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#dc2626;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">❌ Cancelados</div>
      <div style="font-size:28px;font-weight:900;color:#dc2626;line-height:1;margin-bottom:10px;">6</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC perdido</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 117K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR perdido</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 9K</span></div>
    </div>
    </div>
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          <th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:110px;">NP</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Cliente</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Responsável</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Etapa</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Vencimento</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Atraso</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">VTC</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">MRR</th>
        </tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115057</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TECCLOUD SERVICOS DE TECNOLOGIA AHU LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#fef9c3;color:#92400e;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Em análise pelo cliente</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jan/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">193d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 13.500,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115039</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SANTA CASA DE MISERICORDIA DA BAHIA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#fef9c3;color:#92400e;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Em análise pelo cliente</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Abr/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">103d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 14.196,96</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.183,08</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115036</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">S3CURITY</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#fef9c3;color:#92400e;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Em análise pelo cliente</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">73d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.530,69</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115078</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CONNECTION SEGURANÇA E GESTÃO DE TI</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#eff6ff;color:#2563eb;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Processo Financeiro</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 17.635,19</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 994,29</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115074</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ZILOR ENERGIA E ALIMENTOS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 38.463,24</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.205,27</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115072</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">VIAÇÃO OURO E PRATA S.A</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jun/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">42d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.186,04</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 932,17</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115069</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">USINA SAO JOSE DA ESTIVA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 23.608,44</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.967,37</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115067</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">UNIVALI</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 52.236,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.353,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115061</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TORRA TORRA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 53.094,84</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.424,57</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115060</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TIMAC AGRO</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.826,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115059</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TENDA ATACADO</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 19.865,53</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115058</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TEEVO COM E SERVS DE INFORMÁTICA (MI)</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 984,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 82,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115051</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SERVIX</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Abr/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">103d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 10.277,40</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 856,45</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115049</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SERILON BRASIL</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.744,37</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115035</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ROYAL PALM HOTELS & RESORTS (GRUPO ARCEL)</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 35.325,60</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.943,80</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115032</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">RCXIT NETWORK IT EXPERTS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.010,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115031</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">RBS - Televisão Gaúcha SA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 59.339,73</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115030</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">RAPIDONET SISTEMAS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 21.619,93</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.012,92</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115025</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">PERTO S/A PERIFÉRICOS P/ AUTOMAÇÃO - GRAVATAI ( Digicom )</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 4.891,09</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115023</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ORIZON</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">73d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 43.249,84</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.677,32</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115020</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Nauterra</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 13.048,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115019</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">MULTISUPORTE TECNOLOGIA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 1.620,93</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115018</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">MARELLI</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.763,92</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115017</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">MARCOPOLO</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.914,25</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115016</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">M.L.GOMES</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 24.680,28</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.056,69</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115015</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LUXCEL MAXLOG</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.295,12</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 941,26</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115009</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LETTEL</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 8.116,55</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115007</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">KICALDO</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Fev/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">162d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.052,45</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115006</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">KEPLER WEBER</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 10.679,50</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115005</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">JME INFORMÁTICA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jul/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">12d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 26.810,28</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.234,19</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114997</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">INBETTA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 52.892,88</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.407,74</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114996</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">IMPORTADORA BAGE S/A</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 37.488,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.124,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114980</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FRUKI</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.807,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114975</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FCC - FORNECEDORA COMPONENTES QUÍMICOS E COUROS LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 35.148,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.929,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114974</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">EZEX</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.333,54</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114973</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ESTRE AMBIENTAL</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 16.810,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114970</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">DATACOM</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 6.820,06</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114969</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CPA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Nov/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 10.657,47</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114958</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Celk Sistemas</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 121.625,88</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 10.135,49</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114950</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BEG</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.309,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114948</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AUTTAR - GETNET</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jun/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">42d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 20.834,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114946</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATRIO HOTÉIS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jul/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">12d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.184,46</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 441,58</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114945</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATP</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 6.229,62</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115054</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SOTRAN LOGÍSTICA E TRANSPORTE</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 66.993,34</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.313,27</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115040</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SANTA CASA DE MISERICÓRDIA DE PORTO ALEGRE</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mar/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.646,90</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115024</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">PANATLANTICA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.489,43</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 290,78</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115000</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">INSTITUTO FALCAO BAUER DA QUALIDADE</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Abr/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 16.979,65</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 929,72</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114999</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">INOVATECH SOLUÇÕES EM INFORMÁTICA LTDA - EPP</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 4.144,36</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114983</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GOLDEN TECHNOLOGIA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 22.773,48</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.897,79</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114972</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">EQUALITI E SOLUCOES EM TI LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Abr/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.949,99</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114968</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">COTRIBÁ</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mar/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.485,48</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 623,79</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114965</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CONSTRUTORA MARQUISE</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 1.584,62</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr></tbody>
        <tfoot><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;">
          <td colspan="6" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Total · 52 contratos</td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 1.022.753,33</td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 57.957,54</td>
        </tr></tfoot>
      </table>
    </div>
  </div>
  <!-- PF DENISE -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">💼 Aguardando Processo Financeiro — Denise (2)</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#2563eb;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">💼 Em PF Denise</div>
      <div style="font-size:28px;font-weight:900;color:#2563eb;line-height:1;margin-bottom:10px;">2</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total pendente</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 108K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 13K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">ARR potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 42K</span></div>
    </div>
      <div></div><div></div>
    </div>
    <div style="overflow-x:auto;border:1px solid #bfdbfe;border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          <th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:70px;">Age</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:110px;">NP</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Cliente</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">VT</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">MRR</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Abertura</th>
        </tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
              <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114418</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">RAPIDONET SISTEMAS</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 70.040,00</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;">R$ 4.190,00</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
            </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
              <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114516</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AUTTAR - GETNET</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 37.475,00</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;">R$ 8.536,54</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
            </tr></tbody>
          <tfoot><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;">
            <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Total</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 107.515,00</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 12.726,54</td>
            <td></td>
          </tr></tfoot>
        </table>
      </div>
  ...
  <!-- FECHADOS 2026 -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">✅ Fechados 2026 — Projetos Originados (3)</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#059669;"></div>
      ...
      <div style="font-size:28px;font-weight:900;color:#059669;line-height:1;margin-bottom:10px;">3</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 28K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR gerado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 2K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">ARR gerado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 15K</span></div>
    </div>
      <div></div><div></div>
    </div>
    <div style="overflow-x:auto;border:1px solid #bbf7d0;border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          <th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:110px;">NP</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Cliente</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Aprovação</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Lead time</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">VT</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">MRR</th>
        </tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#059669;">NP-117191</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SERILON BRASIL</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">0d</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 2.681,47</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
            </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#059669;">NP-116985</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">NETCENTER INFORMATICA</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">0d</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 17.104,38</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;">R$ 1.330,73</td>
            </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#059669;">NP-115261</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LUXCEL MAXLOG</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">0d</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 8.525,68</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;">R$ 914,28</td>
            </tr></tbody>
          <tfoot><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;">
            <td colspan="4" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#059669;">Total · 3</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 28.311,53</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 2.245,01</td>
          </tr></tfoot>
        </table>
      </div>
    </div>
  ...
  <div class="p26-header" style="margin-bottom:28px;">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:10px;">
      ...
      <span style="background:#fef9c3;color:#92400e;font-size:12px;font-weight:700;padding:4px 14px;border-radius:99px;">⚡ 1 contrato em atraso</span>
    </div>
  </div>
  ...
  <div class="p26-kpi-row" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:40px;">
    <div class="p26-kpi" style="--kpi-accent:#0891b2">
      ...
      <div class="p26-kpi-sub">0 neg · 0 parados +90d</div>
    </div>
    <div class="p26-kpi" style="--kpi-accent:#6b7280">
      <div class="p26-kpi-label">Leads</div>
    ...
    <div class="p26-kpi" style="--kpi-accent:#059669">
      <div class="p26-kpi-label">Fechados 2026</div>
      <div class="p26-kpi-number" style="color:#059669">0</div>
      <div class="p26-kpi-sub">Nenhum</div>
    </div>
    <div class="p26-kpi" style="--kpi-accent:#0891b2">
      <div class="p26-kpi-label">Carteira Contratos</div>
      <div class="p26-kpi-number" style="color:#0891b2">19</div>
      <div class="p26-kpi-sub">MRR R$ 165K · 1 em atraso</div>
    </div>
  </div>
  <!-- PIPELINE CLIENTES -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">📋 Pipeline — Projetos Ativos (19)</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#0891b2;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📦 Projetos Clientes</div>
      <div style="font-size:28px;font-weight:900;color:#0891b2;line-height:1;margin-bottom:10px;">19</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total em carteira</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 224K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Em negociação</span><span style="font-size:11px;font-weight:700;color:#374151;">0 · —</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +90 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +180 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#0284c7;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📨 Proj. Enviados</div>
      <div style="font-size:28px;font-weight:900;color:#0284c7;line-height:1;margin-bottom:10px;">5</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT aguardando</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 160K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Ticket médio</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 32K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Mais antigo (dias)</span><span style="font-size:11px;font-weight:700;color:#374151;">0d</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#374151;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📊 Por Etapa</div>
      <div style="font-size:28px;font-weight:900;color:#374151;line-height:1;margin-bottom:10px;"></div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Elaboração de Projeto</span><span style="font-size:11px;font-weight:700;color:#374151;">7 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Projeto Enviado</span><span style="font-size:11px;font-weight:700;color:#374151;">5 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Qualificação</span><span style="font-size:11px;font-weight:700;color:#374151;">3 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Projeto Aprovado</span><span style="font-size:11px;font-weight:700;color:#374151;">2 projetos</span></div>
    </div>
    </div>
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-113545</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AUTOGLASS</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 70.160,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-116826</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">RODOBENS</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 45.085,68</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-113663</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BULLLA SA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 38.400,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115606</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BULLLA SA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Aprovado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 30.020,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115724</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BULLLA SA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Aprovado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 16.720,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-112412</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CONSTRUTORA NORBERTO ODEBRECHT S.A.</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 16.500,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-111979</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CONSTRUTORA NORBERTO ODEBRECHT S.A.</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 6.720,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-117297</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AUTOGLASS</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-117061</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AUTOGLASS</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-116882</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ENERGY TELECOM</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-116413</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Sapore</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115993</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Sapore</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115992</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SOLVI PARTICIPAÇÕES</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Estimativa de Esforço</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115951</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SOLVI PARTICIPAÇÕES</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115271</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ABBC - Associação Brasileira de Bancos</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-113967</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BOMBRIL S.A</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-113665</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LIFE EMPRESARIAL SAÚDE LTDA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação Concluída</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-113488</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BULLLA SA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-113285</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BULLLA SA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        ...
        <tfoot><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;">
          <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#059669;">Total · 19 projetos</td>
          <td></td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 223.605,68</td>
          <td></td>
        </tr></tfoot>
      </table>
    </div>
  ...
  <!-- LEADS -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">🎯 Leads em Prospecção (9)</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#6b7280;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">🎯 Leads Ativos</div>
      <div style="font-size:28px;font-weight:900;color:#6b7280;line-height:1;margin-bottom:10px;">9</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 315K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Ticket médio</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 35K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +90 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +180 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#d97706;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">💬 Em Negociação</div>
    ...
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-113970</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Data Engenharia</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 172.116,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-114712</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Associação dos Engenheiros da Sabesp</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 142.404,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116839</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Essencis Soluções Ambientais</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116838</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Essencis Soluções Ambientais</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116837</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Essencis Soluções Ambientais</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116833</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Essencis Soluções Ambientais</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116078</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Essencis Soluções Ambientais</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação Concluída</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-115259</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Packing Group</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação Concluída</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-114669</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Associação Educadora e Beneficente</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr></tbody>
        <tfoot><tr style="background:#f8fafc;border-top:2px solid #e5e7eb;">
          <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#374151;">Total · 9 leads</td>
          <td></td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 314.520,00</td>
          <td></td>
        </tr></tfoot>
      </table>
    </div>
  ...
  <!-- CONTRATOS -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">🔄 Contratos em Renovação (19)</div>
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#059669;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">✅ Renovados</div>
      <div style="font-size:28px;font-weight:900;color:#059669;line-height:1;margin-bottom:10px;">2</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC renovado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 491K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR renovado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 46K</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#92400e;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">⚡ Em Análise + PF</div>
      <div style="font-size:28px;font-weight:900;color:#92400e;line-height:1;margin-bottom:10px;">0</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Em análise cliente</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Processo Financeiro</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC em risco</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#7c3aed;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📋 Análise Req.</div>
      <div style="font-size:28px;font-weight:900;color:#7c3aed;line-height:1;margin-bottom:10px;">17</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 1,4M</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 119K</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#dc2626;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">❌ Cancelados</div>
      <div style="font-size:28px;font-weight:900;color:#dc2626;line-height:1;margin-bottom:10px;">1</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC perdido</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 30K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR perdido</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 2K</span></div>
    </div>
    </div>
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          ...
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-116088</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BOMBRIL S.A</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 124.764,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 10.397,00</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115079</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BULLLA SA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Nov/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 35.647,20</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.970,60</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115053</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SOLVI PARTICIPAÇÕES</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 153.504,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 12.792,00</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115052</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SOLVER</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 37.508,64</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.125,72</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115021</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">NISSIN FOODS DO BRASIL LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 44.040,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.670,00</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115011</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LIFE EMPRESARIAL SAÚDE LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Nov/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 178.058,04</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 14.838,17</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114989</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GRUPO THATHI - PANAMBY</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Abr/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">103d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 37.921,92</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.160,16</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114984</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Gourmet Sports Hospitality Serviços de Alimentação Ltda</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 68.467,68</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 5.705,64</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114971</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ENERGY TELECOM</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Nov/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 10.942,80</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 911,90</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114966</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CONSTRUTORA NORBERTO ODEBRECHT S.A.</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 50.484,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.207,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114961</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.322,37</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114959</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CENTRO HOSPITALAR DE SETÚBAL, EPE (TCSI)</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Nov/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 83.001,12</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114947</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AUTOGLASS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Nov/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 76.183,32</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 6.348,61</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114941</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ANDRADE GUTIERREZ</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 72.866,28</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 6.072,19</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114939</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ADESTE PARTICIPACOES E EMPREENDIMENTOS LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 25.788,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.149,00</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114797</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ACHE LABORATÓRIOS FARMACÊUTICOS SA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 409.368,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 42.839,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114796</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ABBC - Associação Brasileira de Bancos</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 4.315,67</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-115042</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Sapore</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mar/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 178.403,92</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 14.866,99</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#0891b2;">NP-114991</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">HOSPITAL CARE</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Talita <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jun/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 312.940,69</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 30.705,52</td>
        </tr></tbody>
        <tfoot><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;">
          <td colspan="6" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Total · 19 contratos</td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 1.915.527,65</td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 164.759,50</td>
        </tr></tfoot>
      </table>
    </div>
  </div>
  ...
  <div class="p26-kpi-row" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:40px;">
    ...
    <div class="p26-kpi" style="--kpi-accent:#059669">
      <div class="p26-kpi-label">Fechados 2026</div>
      <div class="p26-kpi-number" style="color:#059669">1</div>
      <div class="p26-kpi-sub">R$ 23K · MRR R$ 4K</div>
    </div>
    <div class="p26-kpi" style="--kpi-accent:#d97706">
      <div class="p26-kpi-label">Carteira Contratos</div>
      <div class="p26-kpi-number" style="color:#d97706">1</div>
      <div class="p26-kpi-sub">MRR R$ 22K · 0 em atraso</div>
    </div>
  </div>
  <!-- PIPELINE CLIENTES -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">📋 Pipeline — Projetos Ativos (11)</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#d97706;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📦 Projetos Clientes</div>
      <div style="font-size:28px;font-weight:900;color:#d97706;line-height:1;margin-bottom:10px;">11</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total em carteira</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 5K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Em negociação</span><span style="font-size:11px;font-weight:700;color:#374151;">0 · —</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +90 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +180 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#0284c7;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📨 Proj. Enviados</div>
      <div style="font-size:28px;font-weight:900;color:#0284c7;line-height:1;margin-bottom:10px;">3</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT aguardando</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 5K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Ticket médio</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 2K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Mais antigo (dias)</span><span style="font-size:11px;font-weight:700;color:#374151;">0d</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#374151;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📊 Por Etapa</div>
      <div style="font-size:28px;font-weight:900;color:#374151;line-height:1;margin-bottom:10px;"></div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Elaboração de Projeto</span><span style="font-size:11px;font-weight:700;color:#374151;">5 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Projeto Enviado</span><span style="font-size:11px;font-weight:700;color:#374151;">3 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Qualificação</span><span style="font-size:11px;font-weight:700;color:#374151;">2 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Qualificação Concluída</span><span style="font-size:11px;font-weight:700;color:#374151;">1 projeto</span></div>
    </div>
    </div>
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-117291</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">HOSPITAL MAE DE DEUS (AESC)</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 4.560,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-117665</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-117553</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">UNIDASUL DISTRIBUIDORA ALIMENTÍCIA S.A.</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-117527</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">INTERCITY</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação Concluída</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-117472</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CERVEJARIA PETRÓPOLIS</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-117408</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CASTROLANDA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-117391</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">HOSPITAL MAE DE DEUS (AESC)</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-117096</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-115823</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GGT SOLUÇÃO TECNOLOGICAS LTDA (ANGOLAPREV)</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-115397</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CASTROLANDA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-114780</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CASTROLANDA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        ...
        <tfoot><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;">
          <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#059669;">Total · 11 projetos</td>
          <td></td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 4.560,00</td>
          <td></td>
        </tr></tfoot>
      </table>
    </div>
  ...
  <div style="margin-bottom:40px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      ...
      <div style="display:none;background:#6b7280;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">🎯 Leads Ativos</div>
      <div style="font-size:28px;font-weight:900;color:#6b7280;line-height:1;margin-bottom:10px;">5</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Ticket médio</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +90 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +180 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#d97706;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">💬 Em Negociação</div>
    ...
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-117655</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Cobra Correntes</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-117145</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GRUPO GR</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116900</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Assembléia de Deus Ministério</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Projeto</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116738</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CMTR</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116422</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Agrex do Brasil</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr></tbody>
        <tfoot><tr style="background:#f8fafc;border-top:2px solid #e5e7eb;">
          <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#374151;">Total · 5 leads</td>
          <td></td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 0,00</td>
          <td></td>
        </tr></tfoot>
      </table>
    </div>
  ...
  <!-- CONTRATOS -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">🔄 Contratos em Renovação (1)</div>
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#059669;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">✅ Renovados</div>
      <div style="font-size:28px;font-weight:900;color:#059669;line-height:1;margin-bottom:10px;">0</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC renovado</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR renovado</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#92400e;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">⚡ Em Análise + PF</div>
      ...
      <div style="display:none;background:#7c3aed;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📋 Análise Req.</div>
      <div style="font-size:28px;font-weight:900;color:#7c3aed;line-height:1;margin-bottom:10px;">1</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 264K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 22K</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#dc2626;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">❌ Cancelados</div>
      <div style="font-size:28px;font-weight:900;color:#dc2626;line-height:1;margin-bottom:10px;">0</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC perdido</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR perdido</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div>
    </div>
    </div>
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          ...
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#d97706;">NP-116091</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CERVEJARIA PETRÓPOLIS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Ines</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 263.616,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 21.968,61</td>
        </tr></tbody>
        <tfoot><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;">
          <td colspan="6" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Total · 1 contratos</td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 263.616,00</td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 21.968,61</td>
        </tr></tfoot>
      </table>
    </div>
  </div>
  ...
  <div style="margin-bottom:40px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      ...
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">💼 Em PF Denise</div>
      <div style="font-size:28px;font-weight:900;color:#2563eb;line-height:1;margin-bottom:10px;">2</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total pendente</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 41K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 18K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">ARR potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 18K</span></div>
    </div>
      <div></div><div></div>
    </div>
    <div style="overflow-x:auto;border:1px solid #bfdbfe;border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          <th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:70px;">Age</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:110px;">NP</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Cliente</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">VT</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">MRR</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Abertura</th>
              ...
              <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114520</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Nutrire Indústria de Alimentos</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 23.087,00</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
            </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
              <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-117285</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 18.240,00</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;">R$ 18.240,00</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
            </tr></tbody>
          <tfoot><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;">
            <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Total</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 41.327,00</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 18.240,00</td>
            <td></td>
          </tr></tfoot>
        </table>
      </div>
  ...
  <!-- FECHADOS 2026 -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">✅ Fechados 2026 — Projetos Originados (1)</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#059669;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">✅ Fechados 2026</div>
      <div style="font-size:28px;font-weight:900;color:#059669;line-height:1;margin-bottom:10px;">1</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 23K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR gerado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 4K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">ARR gerado</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div>
    </div>
      <div></div><div></div>
    </div>
    <div style="overflow-x:auto;border:1px solid #bbf7d0;border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          <th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:110px;">NP</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Cliente</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Aprovação</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Lead time</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">VT</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">MRR</th>
              ...
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#059669;">NP-115875</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CASTROLANDA</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">0d</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 23.472,00</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;">R$ 3.912,00</td>
            </tr></tbody>
          <tfoot><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;">
            <td colspan="4" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#059669;">Total · 1</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 23.472,00</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 3.912,00</td>
          </tr></tfoot>
        </table>
      </div>
    </div>
  ...
  <div class="p26-header" style="margin-bottom:28px;">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:10px;">
      ...
      <span style="background:#eff6ff;color:#2563eb;font-size:12px;font-weight:700;padding:4px 14px;border-radius:99px;">💼 2 aguardando PF</span>
      <span style="background:#fef9c3;color:#92400e;font-size:12px;font-weight:700;padding:4px 14px;border-radius:99px;">⚡ 7 contratos em atraso</span>
    </div>
  </div>
  ...
  <div class="p26-kpi-row" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:40px;">
    ...
    <div class="p26-kpi" style="--kpi-accent:#059669">
      <div class="p26-kpi-label">Fechados 2026</div>
      <div class="p26-kpi-number" style="color:#059669">3</div>
      <div class="p26-kpi-sub">R$ 18K</div>
    </div>
    <div class="p26-kpi" style="--kpi-accent:#2563eb">
      <div class="p26-kpi-label">Carteira Contratos</div>
      <div class="p26-kpi-number" style="color:#2563eb">51</div>
      <div class="p26-kpi-sub">MRR R$ 269K · 7 em atraso</div>
    </div>
  </div>
  <!-- PIPELINE CLIENTES -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">📋 Pipeline — Projetos Ativos (18)</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#2563eb;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📦 Projetos Clientes</div>
      <div style="font-size:28px;font-weight:900;color:#2563eb;line-height:1;margin-bottom:10px;">18</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total em carteira</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 437K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Em negociação</span><span style="font-size:11px;font-weight:700;color:#374151;">0 · —</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +90 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +180 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#0284c7;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📨 Proj. Enviados</div>
      <div style="font-size:28px;font-weight:900;color:#0284c7;line-height:1;margin-bottom:10px;">6</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT aguardando</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 393K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Ticket médio</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 66K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Mais antigo (dias)</span><span style="font-size:11px;font-weight:700;color:#374151;">0d</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#374151;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📊 Por Etapa</div>
      <div style="font-size:28px;font-weight:900;color:#374151;line-height:1;margin-bottom:10px;"></div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Projeto Enviado</span><span style="font-size:11px;font-weight:700;color:#374151;">6 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Qualificação</span><span style="font-size:11px;font-weight:700;color:#374151;">5 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Elaboração de Caderno Técnico</span><span style="font-size:11px;font-weight:700;color:#374151;">3 projetos</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Processo Financeiro</span><span style="font-size:11px;font-weight:700;color:#374151;">2 projetos</span></div>
    </div>
    </div>
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-112013</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 280.000,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-117209</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">STEFANINI</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 76.632,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-117218</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">NGAHR</td>
          <td style="padding:11px 16px;"><span style="background:#eff6ff;color:#2563eb;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Processo Financeiro</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 19.512,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115314</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GGT SOLUÇÃO TECNOLOGICAS LTDA (ANGOLAPREV)</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 17.670,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115363</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SENAC RJ</td>
          <td style="padding:11px 16px;"><span style="background:#eff6ff;color:#2563eb;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Processo Financeiro</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 13.680,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-116484</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.900,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-112683</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">HOSPITAL MAE DE DEUS (AESC)</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Caderno Técnico</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 10.500,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-116880</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Inetum Tecnologia</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.050,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-117592</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-117337</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AUXILIADORA PREDIAL</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Estimativa de Esforço</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-117200</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-117199</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-117194</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATRIO HOTÉIS</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-117024</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-116725</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">IRANI PAPEL E EMBALAGEM S.A</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115755</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SAQUE PAGUE</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Estimativa de Esforço</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-110527</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">S3CURITY</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Caderno Técnico</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-110525</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">S3CURITY</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Elaboração de Caderno Técnico</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        ...
        <tfoot><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;">
          <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#059669;">Total · 18 projetos</td>
          <td></td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 436.944,00</td>
          <td></td>
        </tr></tfoot>
      </table>
    </div>
  ...
  <div style="margin-bottom:40px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      ...
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">🎯 Leads Ativos</div>
      <div style="font-size:28px;font-weight:900;color:#6b7280;line-height:1;margin-bottom:10px;">5</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 278K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Ticket médio</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 56K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +90 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Parados +180 dias</span><span style="font-size:11px;font-weight:700;color:#374151;">0</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#d97706;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">💬 Em Negociação</div>
    ...
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          ...
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-117545</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">RedeMob Consórcio</td>
          <td style="padding:11px 16px;"><span style="background:#f0f9ff;color:#0284c7;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Projeto Enviado</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 277.992,00</td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-117712</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Sementes Roos</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação Concluída</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116258</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Unimed Central de Serviços - RS</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação Concluída</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-116159</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">REDE BRASIL GESTÃO DE ATIVOS</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação Concluída</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#6b7280;">NP-115797</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ALPARGATAS</td>
          <td style="padding:11px 16px;"><span style="background:#f3f4f6;color:#374151;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Qualificação Concluída</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
        </tr></tbody>
        <tfoot><tr style="background:#f8fafc;border-top:2px solid #e5e7eb;">
          <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#374151;">Total · 5 leads</td>
          <td></td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 277.992,00</td>
          <td></td>
        </tr></tfoot>
      </table>
    </div>
  ...
  <!-- CONTRATOS -->
  <div style="margin-bottom:40px;">
    <div class="p26-section-label" style="margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid var(--border);">🔄 Contratos em Renovação (51)</div>
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:16px;">
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#059669;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">✅ Renovados</div>
      <div style="font-size:28px;font-weight:900;color:#059669;line-height:1;margin-bottom:10px;">16</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC renovado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 1,1M</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR renovado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 79K</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#92400e;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">⚡ Em Análise + PF</div>
      <div style="font-size:28px;font-weight:900;color:#92400e;line-height:1;margin-bottom:10px;">9</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Em análise cliente</span><span style="font-size:11px;font-weight:700;color:#374151;">6</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">Processo Financeiro</span><span style="font-size:11px;font-weight:700;color:#374151;">3</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC em risco</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 366K</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#7c3aed;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">📋 Análise Req.</div>
      <div style="font-size:28px;font-weight:900;color:#7c3aed;line-height:1;margin-bottom:10px;">26</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 2,1M</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 160K</span></div>
    </div>
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:24px 28px;position:relative;overflow:hidden;transition:transform .15s ease,box-shadow .15s ease;">
      <div style="display:none;background:#dc2626;"></div>
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">❌ Cancelados</div>
      <div style="font-size:28px;font-weight:900;color:#dc2626;line-height:1;margin-bottom:10px;">5</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VTC perdido</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 152K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR perdido</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 12K</span></div>
    </div>
    </div>
    <div style="overflow-x:auto;border:1px solid var(--border);border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          ...
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115702</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#fef9c3;color:#92400e;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Em análise pelo cliente</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">73d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 47.856,60</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.988,05</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115077</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">NETCENTER INFORMATICA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#fef9c3;color:#92400e;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Em análise pelo cliente</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jul/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">12d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.254,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115071</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">VERZANI & SANDRINI LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#fef9c3;color:#92400e;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Em análise pelo cliente</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.231,60</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115063</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Trt Da 4ª Região</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#fef9c3;color:#92400e;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Em análise pelo cliente</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 78.738,72</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 6.561,56</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115055</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">STEFANINI</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#fef9c3;color:#92400e;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Em análise pelo cliente</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 71.022,60</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 5.918,55</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114986</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GRPCOM GRUPO PARANAENSE DE COMUNICAÇÃO</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#fef9c3;color:#92400e;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Em análise pelo cliente</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jul/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">12d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 82.428,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 6.869,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115047</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SEPHORA DO BRASIL PARTICIPAÇÕES S.A.</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#eff6ff;color:#2563eb;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Processo Financeiro</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 19.190,76</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.599,23</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114978</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FORSALES MECANET</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#eff6ff;color:#2563eb;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Processo Financeiro</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jul/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">12d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 16.797,84</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.399,82</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114944</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ASSOCIACAO HOSPITALAR MOINHOS DE VENTO</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#eff6ff;color:#2563eb;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Processo Financeiro</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mar/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">134d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 45.084,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.757,00</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-116108</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 237.043,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 19.752,92</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-116092</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CORTEL</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Nov/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 15.150,30</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.377,72</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115064</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">UNIDASUL DISTRIBUIDORA ALIMENTÍCIA S.A.</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 292.685,64</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 24.390,47</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115062</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">TRISUL</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 12.650,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 450,00</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115050</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SERVIÇO SOCIAL DO COMÉRCIO - ADMINISTRAÇÃO REGIONAL NO ESTADO DO RIO DE JANEIRO (SESC/ ARRJ)</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 35.128,24</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115045</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SECRETARIA DA FAZENDA DO ESTADO DO ALAGOAS (SEFAZ AL)</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 37.234,16</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115041</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SAO JOAO FARMACIAS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 34.863,24</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.905,27</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115028</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">QINTESS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 15.000,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.250,00</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115014</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LOJAS LEBES</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 65.047,32</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 5.420,61</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115013</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LOJAS RENNER</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 6.254,40</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 521,20</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115010</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LG SISTEMAS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 162.087,60</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 21.863,99</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115008</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">KleyHertz Farmacêutica</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 12.823,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115003</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">IRANI PAPEL E EMBALAGEM S.A</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 176.916,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 14.743,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114992</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">HOSPITAL DE CLINICAS (HCPA)</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 30.348,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.529,00</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114987</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GRUPO MARINGÁ</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 24.792,79</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.466,15</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114985</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GOVERNANÇA BRASIL</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 121.044,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 10.087,00</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114981</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FUNDAÇÃO SÃO FRANCISCO XAVIER - FSFX</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 147.152,06</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 9.723,80</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114979</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 160.646,04</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 13.387,17</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114976</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FERBASA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 55.336,87</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.011,49</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114964</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CONSTRUCAP CCPS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 10.966,20</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 913,85</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114957</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">CASTROLANDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Set/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 69.931,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.098,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114954</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BRASTORAGE - THINK</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Out/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 22.265,76</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.855,48</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114951</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BIONOVIS S.A. - COMPANHIA BRASILEIRA DE BIOTECNOLOGIA FARMACEUTICA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Dez/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 69.426,18</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.629,78</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114946</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">ATRIO HOTÉIS</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Anderson</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jul/26</td>
          ...
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114942</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AREZZO INDUSTRIA E COMERCIO LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Ago/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 80.096,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.210,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114940</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AGIPLAN SERVIÇOS FINANCEIROS (AGIBANK)</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f5f3ff;color:#7c3aed;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Análise de Requisição</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jul/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#dc2626;font-weight:700;">12d</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 176.970,72</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 14.747,56</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115070</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">VANTIX TECNOLOGIA COMÉRCIO E SERVIÇOS DE INFORMÁTICA LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.001,77</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115066</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">UNIMED VALES DO TAQUARI E RIO PARDO LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Fev/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 38.120,85</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115065</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">UNIMED PORTO ALEGRE</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mar/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 132.818,66</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 11.068,22</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115046</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SENAC RJ</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Fev/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 46.440,53</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115044</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SCGAS - COMPANHIA DE GAS DE SANTA CATARINA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mar/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.351,36</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115043</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SAQUE PAGUE</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro</td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Fev/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 60.982,84</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 5.081,90</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115038</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">SAFEWEB</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 133.565,79</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 11.130,48</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115033</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">RESERVA BRASILEIRA INDUSTRIA E COMERCIO LTDA</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Abr/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 22.804,08</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.900,34</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115026</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Pestana Leilões</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.692,90</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115022</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">OCYAN</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jan/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 9.176,64</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-115012</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">LOJAS COLOMBO S/A</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mai/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 8.538,28</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 711,52</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114993</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">HOSPITAL MAE DE DEUS (AESC)</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jul/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 98.947,56</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 8.245,63</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114982</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">GGT SOLUÇÃO TECNOLOGICAS LTDA (ANGOLAPREV)</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mar/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 54.105,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114977</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FLOWTI</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Jun/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 50.601,72</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.216,81</td>
        </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114953</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">BRASKEM</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Abr/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 32.400,00</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.700,00</td>
        </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
          <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-114949</td>
          <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">AUXILIADORA PREDIAL</td>
          <td style="padding:11px 16px;font-size:11px;color:#6b7280;">Pedro <span style="background:#eff6ff;color:#2563eb;font-size:9px;font-weight:700;padding:1px 5px;border-radius:99px;">via Denise</span></td>
          <td style="padding:11px 16px;"><span style="background:#f0fdf4;color:#059669;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;white-space:nowrap;">Renovado</span></td>
          <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">Mar/26</td>
          <td style="padding:11px 16px;text-align:center;"><span style="color:#d1d5db;">—</span></td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 412.288,08</td>
          <td style="padding:11px 16px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 34.357,34</td>
        </tr></tbody>
        <tfoot><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;">
          <td colspan="6" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Total · 51 contratos</td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 3.571.483,16</td>
          <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 269.281,49</td>
        </tr></tfoot>
      </table>
    </div>
  </div>
  ...
  <div style="margin-bottom:40px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      ...
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">💼 Em PF Denise</div>
      <div style="font-size:28px;font-weight:900;color:#2563eb;line-height:1;margin-bottom:10px;">2</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total pendente</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 14K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">ARR potencial</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 10K</span></div>
    </div>
      <div></div><div></div>
    </div>
    <div style="overflow-x:auto;border:1px solid #bfdbfe;border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          <th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:70px;">Age</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:110px;">NP</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Cliente</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">VT</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">MRR</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Abertura</th>
              ...
              <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-113414</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">IRANI PAPEL E EMBALAGEM S.A</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 9.880,00</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
            </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
              <td style="padding:11px 16px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;">🟢 0d</span></td>
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#2563eb;">NP-116693</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 4.080,00</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">—</td>
            </tr></tbody>
          <tfoot><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;">
            <td colspan="3" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Total</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 13.960,00</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 0,00</td>
            <td></td>
          </tr></tfoot>
        </table>
      </div>
  ...
  <div style="margin-bottom:40px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px;">
      ...
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:6px;">✅ Fechados 2026</div>
      <div style="font-size:28px;font-weight:900;color:#059669;line-height:1;margin-bottom:10px;">3</div>
      <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">VT total</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 18K</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">MRR gerado</span><span style="font-size:11px;font-weight:700;color:#374151;">—</span></div><div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f3f4f6;"><span style="font-size:11px;color:#6b7280;">ARR gerado</span><span style="font-size:11px;font-weight:700;color:#374151;">R$ 18K</span></div>
    </div>
      <div></div><div></div>
    </div>
    <div style="overflow-x:auto;border:1px solid #bbf7d0;border-radius:12px;">
      <table style="width:100%;border-collapse:collapse;">
        <thead><tr>
          <th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;width:110px;">NP</th><th style="padding:11px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Cliente</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Aprovação</th><th style="padding:11px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">Lead time</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">VT</th><th style="padding:11px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;background:#f8fafc;white-space:nowrap;">MRR</th>
              ...
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#059669;">NP-117439</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">Trt Da 4ª Região</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">01/07/2026</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">0d</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 1.417,00</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
            </tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;">
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#059669;">NP-116022</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">IRANI PAPEL E EMBALAGEM S.A</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">0d</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;">R$ 16.720,00</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
            </tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;">
              <td style="padding:11px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#059669;">NP-115653</td>
              <td style="padding:11px 16px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td>
              <td style="padding:11px 16px;text-align:center;font-size:11px;color:#6b7280;">0d</td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#111827;"><span style="color:#d1d5db;">—</span></td>
              <td style="padding:11px 16px;text-align:right;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td>
            </tr></tbody>
          <tfoot><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;">
            <td colspan="4" style="padding:11px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#059669;">Total · 3</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#111827;">R$ 18.137,00</td>
            <td style="padding:11px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 0,00</td>
          </tr></tfoot>
        </table>
      </div>
...
<div class="page">
  ...
  <div class="p26-header">
    ...
    <div class="p26-meta">
      Fonte: Relatório de Projetos · S2M7
      <strong>Atualizado em 13/07/2026</strong>
    </div>
  </div>
  ...
  <div class="p26-kpi-row">
    ...
    <div class="p26-kpi" style="--kpi-accent:#2563eb">
      <div class="p26-kpi-label">Projetos Ativos</div>
      <div class="p26-kpi-number">120</div>
    ...
    <div class="p26-kpi" style="--kpi-accent:#7c3aed">
      ...
      <div class="p26-kpi-number">50</div>
    ...
    <div class="p26-kpi" style="--kpi-accent:#d97706">
      ...
      <div class="p26-kpi-number">3</div>
    ...
    <div class="p26-kpi" style="--kpi-accent:#0891b2">
      ...
      <div class="p26-kpi-number" style="font-size:30px;letter-spacing:-1px;">R$ 1,44M</div>
      <div class="p26-kpi-sub">Etapa <strong>Projeto Enviado</strong></div>
    </div>
...
<!-- Seção 3 — Detalhe Projetos Fechados -->
  ...
  <div style="background:#fff;border:1px solid var(--border);border-radius:16px;overflow:hidden;">
    <div style="display:flex;justify-content:space-between;align-items:center;padding:18px 20px 14px;border-bottom:1px solid var(--border);">
      <div><div style="font-size:13px;font-weight:700;color:#111827;">Aprovados ≥ Jan / 2026</div><div style="font-size:12px;color:#6b7280;margin-top:2px;">39 projetos · ordenado por data de aprovação</div></div>
      <div style="display:flex;gap:16px;font-size:11px;font-weight:700;color:#6b7280;align-items:center;"><span style="background:#dcfce7;color:#166534;font-size:12px;font-weight:700;padding:5px 14px;border-radius:99px;">39 projetos</span><span>VT <strong style="color:#111827;margin-left:4px;">R$ 625.641,06</strong></span><span style="color:#7c3aed;">MRR <strong style="margin-left:4px;">R$ 36.023,06</strong></span><span style="color:#0891b2;">ARR <strong style="margin-left:4px;">R$ 261.399,65</strong></span></div></div>
    <div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">
      ...
      <tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117439</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Trt Da 4ª Região</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/07/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.417,60</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117451</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Task Sistemas</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 4.190,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 19.760,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117191</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">SERILON BRASIL</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 2.681,47</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116985</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">NETCENTER INFORMATICA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 1.330,73</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 9.120,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115261</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">LUXCEL MAXLOG</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/06/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 914,28</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 3.040,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-117118</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">STEFANINI</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/05/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 183,93</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.103,58</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116804</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/05/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 100,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 100,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116356</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">AUXILIADORA PREDIAL</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/05/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 3.500,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116763</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 400,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116700</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 100,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 100,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116667</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116531</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 100,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.200,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116022</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">IRANI PAPEL E EMBALAGEM S.A</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 16.720,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115875</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">CASTROLANDA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/04/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 3.912,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116595</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 5.122,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116388</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116294</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 200,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116138</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">AUXILIADORA PREDIAL</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.140,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116129</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116095</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 200,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116081</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">NETCENTER INFORMATICA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 3.800,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-116040</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115812</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">BRASTORAGE - THINK</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.140,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115715</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">CORPFLEX INFORMATICA LTDA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 992,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-113976</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">SERVIÇO SOCIAL DO COMÉRCIO - ADMINISTRAÇÃO REGIONAL NO ESTADO DO RIO DE JANEIRO (SESC/ ARRJ)</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/03/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 79.344,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115653</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Pedro</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115586</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Cetrel - Central de Tratamento de Efluentes Líquidos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 1.520,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114660</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">M.L.GOMES</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 6.080,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114632</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Novvacore Jr & Js - Telecom LTDA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 3.588,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114138</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">TORRA TORRA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 116,12</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 760,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-111340</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRUKI</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/02/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115316</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">FRIGELAR</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 300,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115262</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">INTERCITY</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 76.721,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-115157</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">STEFANINI</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 5.240,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114662</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">IRANI PAPEL E EMBALAGEM S.A</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114581</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">SOLVI PARTICIPAÇÕES</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 6.576,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114454</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">KICALDO</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 760,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-113067</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">EBM Incorporações S/A</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 1.450,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;">R$ 30.400,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-112107</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">SABEMI SEGURADORA</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:center;font-size:11px;color:#374151;">01/01/2026</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#7c3aed;">R$ 800,00</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:600;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;"><td colspan="3" style="padding:12px 16px;font-size:11px;font-weight:700;text-transform:uppercase;color:#059669;">Total · 39 projetos</td><td style="padding:12px 16px;text-align:right;font-size:13px;font-weight:800;color:#111827;">R$ 625.641,06</td><td style="padding:12px 16px;text-align:right;font-size:13px;font-weight:800;color:#7c3aed;">R$ 36.023,06</td><td style="padding:12px 16px;text-align:right;font-size:13px;font-weight:800;color:#0891b2;">R$ 261.399,65</td></tr></tbody>
      <tfoot><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;"><td colspan="3" style="padding:12px 16px;font-size:11px;font-weight:700;text-transform:uppercase;color:#059669;">Total · 39 projetos</td><td style="padding:12px 16px;text-align:right;font-weight:800;color:#111827;">R$ 625.641,06</td><td style="padding:12px 16px;text-align:right;font-weight:800;color:#7c3aed;">R$ 36.023,06</td><td style="padding:12px 16px;text-align:right;font-weight:800;color:#0891b2;">R$ 261.399,65</td></tr></tfoot>
    </table></div>
  </div>
...
<!-- Seção 5 — Fechados por Mês -->
  ...
  <div style="background:#fff;border:1px solid var(--border);border-radius:16px;overflow:hidden;">
    <div style="display:flex;justify-content:space-between;align-items:center;padding:18px 20px 14px;border-bottom:1px solid var(--border);">
      ...
      <span style="background:#f0fdf4;color:#059669;font-size:12px;font-weight:700;padding:5px 14px;border-radius:99px;border:1px solid #bbf7d0;">Total: R$ 625.641,06</span>
    </div>
    <div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">
  ...
  <div style="background:#fff;border:1px solid var(--border);border-radius:16px;overflow:hidden;margin-bottom:8px;">
    <div style="display:flex;justify-content:space-between;align-items:center;padding:16px 20px;border-bottom:1px solid var(--border);">
      <div>
        ...
        <div style="font-size:12px;color:#6b7280;margin-top:2px;">Comparativo S1M7 vs. S2M7 · semana corrente</div>
      </div>
      <div style="display:flex;gap:8px;">
        <span style="background:#f5f3ff;color:#7c3aed;font-size:11px;font-weight:700;padding:4px 12px;border-radius:99px;">▲ 2 entradas</span>
        <span style="background:#f0fdf4;color:#166534;font-size:11px;font-weight:700;padding:4px 12px;border-radius:99px;">▼ 0 saídas</span>
      </div>
    </div>
    <div style="padding:10px 20px 6px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#7c3aed;background:#faf5ff;border-bottom:1px solid #ede9fe;">▲ Entraram no Processo Financeiro · R$ 60.562,00</div>
    <div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">
      ...
      <tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114520</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">Nutrire Indústria de Alimentos</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 23.087,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:8px 14px;font-family:monospace;font-size:11px;font-weight:600;color:#7c3aed;">NP-114516</td><td style="padding:8px 14px;font-size:12px;font-weight:600;color:#111827;">AUTTAR - GETNET</td><td style="padding:8px 14px;font-size:11px;color:#6b7280;">Denise</td><td style="padding:8px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 37.475,00</td></tr><tr style="background:#f5f3ff;border-top:2px solid #e9d5ff;"><td colspan="3" style="padding:9px 14px;font-size:11px;font-weight:700;text-transform:uppercase;color:#7c3aed;">Total · 2 projetos</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#7c3aed;">R$ 60.562,00</td></tr></tbody>
    </table></div>
    ...
    <div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">
      ...
      <tbody><tr style="background:#f9fafb;"><td colspan="5" style="padding:16px 14px;text-align:center;font-size:12px;color:#9ca3af;">Nenhuma movimentação de Processo Financeiro nesta semana (S1M7 → S2M7)</td></tr></tbody>
    </table></div>
  </div>
  ...
  <div style="background:#fff;border:1px solid var(--border);border-radius:16px;overflow:hidden;margin-bottom:24px;">
    <div style="display:flex;justify-content:space-between;align-items:center;padding:16px 20px 14px;border-bottom:1px solid var(--border);">
      ...
      <div style="display:flex;gap:10px;align-items:center;">
        <span style="background:#fef3c7;color:#92400e;font-size:12px;font-weight:700;padding:5px 14px;border-radius:99px;border:1px solid #fde68a;">3 projetos</span>
        <span style="background:#fff;border:1px solid #e5e7eb;font-size:12px;font-weight:700;color:#111827;padding:5px 14px;border-radius:99px;">VT R$ 153.041,42</span>
      </div>
    </div>
    <div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">
      ...
      <tbody><tr style="background:#ffffff;border-bottom:1px solid #fef3c7;"><td style="padding:10px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#f59e0b;">NP-116087</td><td style="padding:10px 16px;font-size:12px;font-weight:600;color:#111827;">SANTA CASA DE MISERICÓRDIA DE PORTO ALEGRE</td><td style="padding:10px 16px;font-size:11px;color:#6b7280;">Anderson</td><td style="padding:10px 16px;font-size:11px;color:#374151;">Negociação</td><td style="padding:10px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 73.587,00</td><td style="padding:10px 16px;font-size:11px;color:#6b7280;">Consultoria; Licenciamento</td></tr><tr style="background:#fafafa;border-bottom:1px solid #fef3c7;"><td style="padding:10px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#f59e0b;">NP-115705</td><td style="padding:10px 16px;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td><td style="padding:10px 16px;font-size:11px;color:#6b7280;">Pedro</td><td style="padding:10px 16px;font-size:11px;color:#374151;">Negociação</td><td style="padding:10px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 50.000,00</td><td style="padding:10px 16px;font-size:11px;color:#6b7280;">Consultoria</td></tr><tr style="background:#ffffff;border-bottom:1px solid #fef3c7;"><td style="padding:10px 16px;font-family:monospace;font-size:11px;font-weight:600;color:#f59e0b;">NP-115335</td><td style="padding:10px 16px;font-size:12px;font-weight:600;color:#111827;">CPA</td><td style="padding:10px 16px;font-size:11px;color:#6b7280;">Anderson</td><td style="padding:10px 16px;font-size:11px;color:#374151;">Negociação</td><td style="padding:10px 16px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 29.454,42</td><td style="padding:10px 16px;font-size:11px;color:#6b7280;">Licenciamento; Hospedagem; Consultoria</td></tr></tbody>
    </table></div>
  </div>
...
<!-- Seção 4 — Projetos por Responsável -->
  ...
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:24px;">
    ...
    <div class="resp-card" data-resp="Pedro Schreck" onclick="openDrilldown('Pedro Schreck')"
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px;">
        ...
        <div style="font-size:34px;font-weight:800;color:#111827;letter-spacing:-1.5px;line-height:1;">23</div>
      </div>
      <div style="height:4px;background:#f1f5f9;border-radius:2px;margin-bottom:8px;">
        <div style="height:4px;width:19.2%;background:#2563eb;border-radius:2px;transition:width .6s .1s ease;"></div>
      </div>
      <div style="font-size:11px;color:#9ca3af;font-weight:500;">19.2% do total · clique para detalhar</div>
    </div>
    <div class="resp-card" data-resp="Anderson Bamberg" onclick="openDrilldown('Anderson Bamberg')"
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px;">
        ...
        <div style="font-size:34px;font-weight:800;color:#111827;letter-spacing:-1.5px;line-height:1;">42</div>
      </div>
      <div style="height:4px;background:#f1f5f9;border-radius:2px;margin-bottom:8px;">
        <div style="height:4px;width:35.0%;background:#7c3aed;border-radius:2px;transition:width .6s .1s ease;"></div>
      </div>
      <div style="font-size:11px;color:#9ca3af;font-weight:500;">35.0% do total · clique para detalhar</div>
    </div>
    <div class="resp-card" data-resp="Talita Rodrigues" onclick="openDrilldown('Talita Rodrigues')"
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px;">
        ...
        <div style="font-size:34px;font-weight:800;color:#111827;letter-spacing:-1.5px;line-height:1;">28</div>
      </div>
      <div style="height:4px;background:#f1f5f9;border-radius:2px;margin-bottom:8px;">
        <div style="height:4px;width:23.3%;background:#0891b2;border-radius:2px;transition:width .6s .1s ease;"></div>
      </div>
      <div style="font-size:11px;color:#9ca3af;font-weight:500;">23.3% do total · clique para detalhar</div>
    </div>
    <div class="resp-card" data-resp="Ines Cristine Nunes Diogo" onclick="openDrilldown('Ines Cristine Nunes Diogo')"
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px;">
        ...
        <div style="font-size:34px;font-weight:800;color:#111827;letter-spacing:-1.5px;line-height:1;">16</div>
      </div>
      <div style="height:4px;background:#f1f5f9;border-radius:2px;margin-bottom:8px;">
        <div style="height:4px;width:13.3%;background:#d97706;border-radius:2px;transition:width .6s .1s ease;"></div>
      </div>
      <div style="font-size:11px;color:#9ca3af;font-weight:500;">13.3% do total · clique para detalhar</div>
    </div>
  </div>
  ...
  <script>
  (function() {
    var respData = {"Pedro Schreck": {"qtd": 23, "pct": 19.2, "projetos": [{"np": "NP-112013", "cliente": "FRIGELAR", "etapa": "Projeto Enviado", "vt": 280000.0, "abertura": "", "dias": null}, {"np": "NP-117545", "cliente": "RedeMob Consórcio", "etapa": "Projeto Enviado", "vt": 277992.0, "abertura": "", "dias": null}, {"np": "NP-117209", "cliente": "STEFANINI", "etapa": "Projeto Enviado", "vt": 76632.0, "abertura": "", "dias": null}, {"np": "NP-117218", "cliente": "NGAHR", "etapa": "Processo Financeiro", "vt": 19512.0, "abertura": "", "dias": null}, {"np": "NP-115314", "cliente": "GGT SOLUÇÃO TECNOLOGICAS LTDA (ANGOLAPREV)", "etapa": "Projeto Enviado", "vt": 17670.0, "abertura": "", "dias": null}, {"np": "NP-115363", "cliente": "SENAC RJ", "etapa": "Processo Financeiro", "vt": 13680.0, "abertura": "", "dias": null}, {"np": "NP-116484", "cliente": "Argenta Participacoes LTDA", "etapa": "Projeto Enviado", "vt": 11900.0, "abertura": "", "dias": null}, {"np": "NP-112683", "cliente": "HOSPITAL MAE DE DEUS (AESC)", "etapa": "Elaboração de Caderno Técnico", "vt": 10500.0, "abertura": "", "dias": null}, {"np": "NP-116880", "cliente": "Inetum Tecnologia", "etapa": "Projeto Enviado", "vt": 7050.0, "abertura": "", "dias": null}, {"np": "NP-117712", "cliente": "Sementes Roos", "etapa": "Qualificação Concluída", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117592", "cliente": "Argenta Participacoes LTDA", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117337", "cliente": "AUXILIADORA PREDIAL", "etapa": "Estimativa de Esforço", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117200", "cliente": "Argenta Participacoes LTDA", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117199", "cliente": "Argenta Participacoes LTDA", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117194", "cliente": "ATRIO HOTÉIS", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117024", "cliente": "FRIGELAR", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116725", "cliente": "IRANI PAPEL E EMBALAGEM S.A", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116258", "cliente": "Unimed Central de Serviços - RS", "etapa": "Qualificação Concluída", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116159", "cliente": "REDE BRASIL GESTÃO DE ATIVOS", "etapa": "Qualificação Concluída", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115797", "cliente": "ALPARGATAS", "etapa": "Qualificação Concluída", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115755", "cliente": "SAQUE PAGUE", "etapa": "Estimativa de Esforço", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-110527", "cliente": "S3CURITY", "etapa": "Elaboração de Caderno Técnico", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-110525", "cliente": "S3CURITY", "etapa": "Elaboração de Caderno Técnico", "vt": 0.0, "abertura": "", "dias": null}]}, "Anderson Bamberg": {"qtd": 42, "pct": 35.0, "projetos": [{"np": "NP-116087", "cliente": "SANTA CASA DE MISERICÓRDIA DE PORTO ALEGRE", "etapa": "Negociação", "vt": 73587.0, "abertura": "", "dias": null}, {"np": "NP-115250", "cliente": "RRP ENERGIA", "etapa": "Projeto Enviado", "vt": 67387.0, "abertura": "", "dias": null}, {"np": "NP-111370", "cliente": "SANTA CASA DE MISERICORDIA DA BAHIA", "etapa": "Projeto Enviado", "vt": 42522.0, "abertura": "", "dias": null}, {"np": "NP-115925", "cliente": "KleyHertz Farmacêutica", "etapa": "Projeto Enviado", "vt": 35520.0, "abertura": "", "dias": null}, {"np": "NP-115335", "cliente": "CPA", "etapa": "Negociação", "vt": 29454.42, "abertura": "", "dias": null}, {"np": "NP-113547", "cliente": "TIMAC AGRO", "etapa": "Projeto Enviado", "vt": 24192.0, "abertura": "", "dias": null}, {"np": "NP-116728", "cliente": "Novus Automation", "etapa": "Projeto Enviado", "vt": 17464.0, "abertura": "", "dias": null}, {"np": "NP-115788", "cliente": "USINA SAO JOSE DA ESTIVA", "etapa": "Projeto Enviado", "vt": 15664.0, "abertura": "", "dias": null}, {"np": "NP-113863", "cliente": "ROYAL PALM HOTELS & RESORTS (GRUPO ARCEL)", "etapa": "Projeto Enviado", "vt": 12872.0, "abertura": "", "dias": null}, {"np": "NP-114241", "cliente": "PANATLANTICA", "etapa": "Projeto Enviado", "vt": 11400.0, "abertura": "", "dias": null}, {"np": "NP-114308", "cliente": "SPRINGER CARRIER (MIDEA)", "etapa": "Projeto Enviado", "vt": 10776.0, "abertura": "", "dias": null}, {"np": "NP-116911", "cliente": "TENDA ATACADO", "etapa": "Projeto Enviado", "vt": 10260.0, "abertura": "", "dias": null}, {"np": "NP-114405", "cliente": "S3CURITY", "etapa": "Projeto Enviado", "vt": 7600.0, "abertura": "", "dias": null}, {"np": "NP-114151", "cliente": "SERVIX", "etapa": "Elaboração de Projeto", "vt": 6144.0, "abertura": "", "dias": null}, {"np": "NP-113199", "cliente": "S3CURITY", "etapa": "Projeto Enviado", "vt": 5700.0, "abertura": "", "dias": null}, {"np": "NP-116759", "cliente": "SANTA CASA DE MISERICÓRDIA DE PORTO ALEGRE", "etapa": "Projeto Enviado", "vt": 3040.0, "abertura": "", "dias": null}, {"np": "NP-116758", "cliente": "SANTA CASA DE MISERICÓRDIA DE PORTO ALEGRE", "etapa": "Projeto Enviado", "vt": 1520.0, "abertura": "", "dias": null}, {"np": "NP-116385", "cliente": "CONNECTION SEGURANÇA E GESTÃO DE TI", "etapa": "Projeto Enviado", "vt": 1200.0, "abertura": "", "dias": null}, {"np": "NP-114776", "cliente": "IMPORTADORA BAGE S/A", "etapa": "Projeto Enviado", "vt": 1140.0, "abertura": "", "dias": null}, {"np": "NP-117495", "cliente": "ATP", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117480", "cliente": "ATP", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117479", "cliente": "ATRIO HOTÉIS", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117447", "cliente": "HUB4IT TECNOLOGIA", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117359", "cliente": "ATP", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117358", "cliente": "ATP", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117313", "cliente": "RBS - Televisão Gaúcha SA", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117188", "cliente": "ATRIO HOTÉIS", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117185", "cliente": "GRUPO MARINGÁ", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117074", "cliente": "ATRIO HOTÉIS", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117054", "cliente": "SERILON BRASIL", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116721", "cliente": "TORRA TORRA", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116600", "cliente": "Enops Engenharia S.A.", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116428", "cliente": "Costão do Santinho Resort & SPA.", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116426", "cliente": "Attus", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116425", "cliente": "VaBene Confeitaria e Sorveteria", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116424", "cliente": "AFECC - Hospital Santa Rita de Cássia", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116420", "cliente": "Essencis MG", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "115730", "cliente": "IMPORTADORA BAGE S/A", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115517", "cliente": "IMPORTADORA BAGE S/A", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115242", "cliente": "Brasdiesel SA Comercial e Importadora", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115156", "cliente": "TORRA TORRA", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-113281", "cliente": "LUXCEL MAXLOG", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}]}, "Talita Rodrigues": {"qtd": 28, "pct": 23.3, "projetos": [{"np": "NP-113970", "cliente": "Data Engenharia", "etapa": "Projeto Enviado", "vt": 172116.0, "abertura": "", "dias": null}, {"np": "NP-114712", "cliente": "Associação dos Engenheiros da Sabesp", "etapa": "Projeto Enviado", "vt": 142404.0, "abertura": "", "dias": null}, {"np": "NP-113545", "cliente": "AUTOGLASS", "etapa": "Projeto Enviado", "vt": 70160.0, "abertura": "", "dias": null}, {"np": "NP-116826", "cliente": "RODOBENS", "etapa": "Projeto Enviado", "vt": 45085.68, "abertura": "", "dias": null}, {"np": "NP-113663", "cliente": "BULLLA SA", "etapa": "Projeto Enviado", "vt": 38400.0, "abertura": "", "dias": null}, {"np": "NP-115606", "cliente": "BULLLA SA", "etapa": "Projeto Aprovado", "vt": 30020.0, "abertura": "", "dias": null}, {"np": "NP-115724", "cliente": "BULLLA SA", "etapa": "Projeto Aprovado", "vt": 16720.0, "abertura": "", "dias": null}, {"np": "NP-112412", "cliente": "CONSTRUTORA NORBERTO ODEBRECHT S.A.", "etapa": "Elaboração de Projeto", "vt": 16500.0, "abertura": "", "dias": null}, {"np": "NP-111979", "cliente": "CONSTRUTORA NORBERTO ODEBRECHT S.A.", "etapa": "Projeto Enviado", "vt": 6720.0, "abertura": "", "dias": null}, {"np": "NP-117297", "cliente": "AUTOGLASS", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117061", "cliente": "AUTOGLASS", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116882", "cliente": "ENERGY TELECOM", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116839", "cliente": "Essencis Soluções Ambientais", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116838", "cliente": "Essencis Soluções Ambientais", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116837", "cliente": "Essencis Soluções Ambientais", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116833", "cliente": "Essencis Soluções Ambientais", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116413", "cliente": "Sapore", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116078", "cliente": "Essencis Soluções Ambientais", "etapa": "Qualificação Concluída", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115993", "cliente": "Sapore", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115992", "cliente": "SOLVI PARTICIPAÇÕES", "etapa": "Estimativa de Esforço", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115951", "cliente": "SOLVI PARTICIPAÇÕES", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115271", "cliente": "ABBC - Associação Brasileira de Bancos", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115259", "cliente": "Packing Group", "etapa": "Qualificação Concluída", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-114669", "cliente": "Associação Educadora e Beneficente", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-113967", "cliente": "BOMBRIL S.A", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-113665", "cliente": "LIFE EMPRESARIAL SAÚDE LTDA", "etapa": "Qualificação Concluída", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-113488", "cliente": "BULLLA SA", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-113285", "cliente": "BULLLA SA", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}]}, "Ines Cristine Nunes Diogo": {"qtd": 16, "pct": 13.3, "projetos": [{"np": "NP-117291", "cliente": "HOSPITAL MAE DE DEUS (AESC)", "etapa": "Projeto Enviado", "vt": 4560.0, "abertura": "", "dias": null}, {"np": "NP-117665", "cliente": "FRIGELAR", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117655", "cliente": "Cobra Correntes", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117553", "cliente": "UNIDASUL DISTRIBUIDORA ALIMENTÍCIA S.A.", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117527", "cliente": "INTERCITY", "etapa": "Qualificação Concluída", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117472", "cliente": "CERVEJARIA PETRÓPOLIS", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117408", "cliente": "CASTROLANDA", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117391", "cliente": "HOSPITAL MAE DE DEUS (AESC)", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117145", "cliente": "GRUPO GR", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-117096", "cliente": "FRIGELAR", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116900", "cliente": "Assembléia de Deus Ministério", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116738", "cliente": "CMTR", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-116422", "cliente": "Agrex do Brasil", "etapa": "Projeto Enviado", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115823", "cliente": "GGT SOLUÇÃO TECNOLOGICAS LTDA (ANGOLAPREV)", "etapa": "Qualificação", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-115397", "cliente": "CASTROLANDA", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}, {"np": "NP-114780", "cliente": "CASTROLANDA", "etapa": "Elaboração de Projeto", "vt": 0.0, "abertura": "", "dias": null}]}};
    var etapaColors = {
...
<div class="page">
  ...
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:12px;">
    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-top:3px solid #dc2626;border-radius:12px;padding:18px 20px;">
      ...
      <div style="font-size:34px;font-weight:900;color:#dc2626;line-height:1;">11</div>
      <div style="font-size:12px;color:#b91c1c;margin-top:6px;font-weight:600;">7.6% do total</div>
    </div>
    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-top:3px solid #059669;border-radius:12px;padding:18px 20px;">
      ...
      <div style="font-size:34px;font-weight:900;color:#059669;line-height:1;">37</div>
      <div style="font-size:12px;color:#065f46;margin-top:6px;font-weight:600;">27.6% da carteira atual</div>
    </div>
  ...
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:28px;">
    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:16px 20px;">
      <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;margin-bottom:8px;">💰 Carteira Atual</div>
      <div style="font-size:26px;font-weight:900;color:#2563eb;line-height:1;">R$ 7.210.187,20</div>
      <div style="font-size:11px;color:#6b7280;margin-top:4px;">Valor líquido · 134 contratos ativos</div>
    </div>
    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:16px 20px;">
      ...
      <div style="font-size:26px;font-weight:900;color:#dc2626;line-height:1;">−R$ 274.259,93</div>
      <div style="font-size:11px;color:#dc2626;margin-top:4px;font-weight:600;">3.7% vs início do ano</div>
    </div>
    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:16px 20px;">
      ...
      <div style="font-size:26px;font-weight:900;color:#374151;line-height:1;">R$ 53.807,37</div>
  ...
  <div style="margin-bottom:28px;">
    ...
    <div style="overflow-x:auto;border:1px solid #bfdbfe;border-radius:12px;"><table style="width:100%;border-collapse:collapse;"><thead><tr style="background:#f8fafc;"><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Mês</th><th style="padding:10px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Contratos</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">MRR</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">▼ Cancelamentos</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">▼ Reduções</th></tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jan/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">6</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 24.866,29</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#dc2626;font-weight:700;">−R$ 11.469,00</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:700;">−R$ 6.318,56</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Fev/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">4</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 9.058,75</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#dc2626;font-weight:700;">−R$ 265,80</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:700;">−R$ 2.665,32</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Mar/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">5</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 63.567,12</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:700;">−R$ 1.657,71</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Abr/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">4</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 7.899,69</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#dc2626;font-weight:700;">−R$ 9.037,86</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:700;">−R$ 573,00</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Mai/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">6</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 19.303,90</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:700;">−R$ 1.146,00</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jun/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">4</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 31.894,74</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#dc2626;font-weight:700;">−R$ 618,05</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:700;">−R$ 2.566,00</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jul/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">9</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 44.356,75</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Ago/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">21</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 83.489,74</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Set/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">8</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 41.493,30</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Out/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">13</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 112.629,14</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Nov/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">5</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 26.447,00</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Dez/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">11</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#2563eb;">R$ 71.816,48</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;"><td style="padding:10px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Total</td><td style="padding:10px 16px;text-align:center;font-size:13px;font-weight:800;color:#2563eb;">96</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:800;color:#2563eb;">R$ 536.822,90</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#dc2626;font-weight:800;">−R$ 21.390,71</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:800;">−R$ 14.926,59</span></td></tr></tbody></table></div>
  </div>

  <!-- ARR -->
  <div style="margin-bottom:28px;">
    <div class="p26-section-label">ARR — Receita Anual (Manutenção)</div>
    <div style="overflow-x:auto;border:1px solid #bbf7d0;border-radius:12px;"><table style="width:100%;border-collapse:collapse;"><thead><tr style="background:#f8fafc;"><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Mês</th><th style="padding:10px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Contratos</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">ARR</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">▼ Cancelamentos</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">▼ Reduções</th></tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jan/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">5</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 28.524,24</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#dc2626;font-weight:700;">−R$ 17.571,38</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:700;">−R$ 2.021,41</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Fev/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">4</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 51.470,41</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Mar/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">4</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 78.783,55</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Abr/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">1</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 2.832,72</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#dc2626;font-weight:700;">−R$ 4.144,36</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:700;">−R$ 6.876,00</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Mai/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">6</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 100.791,52</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d97706;font-weight:700;">−R$ 13.752,00</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jun/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">1</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 20.840,00</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jul/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">2</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 12.079,50</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Ago/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">8</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 195.123,91</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Set/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">9</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 223.822,51</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Out/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">6</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 41.347,81</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Nov/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">2</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 93.658,59</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Dez/26</td><td style="padding:10px 16px;text-align:center;font-size:13px;color:#6b7280;">12</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#059669;">R$ 193.297,57</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;"><td style="padding:10px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#059669;">Total</td><td style="padding:10px 16px;text-align:center;font-size:13px;font-weight:800;color:#059669;">60</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:800;color:#059669;">R$ 1.042.572,33</td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#dc2626;font-weight:800;">−R$ 21.715,74</span></td><td style="padding:10px 16px;text-align:right;font-size:12px;"><span style="color:#d1d5db;">—</span></td></tr></tbody></table></div>
  </div>

  <!-- Renovados -->
  <div style="margin-bottom:24px;">
    <div class="p26-section-label">✅ Renovados</div>
    <div style="overflow-x:auto;border:1px solid #bbf7d0;border-radius:12px;"><table style="width:100%;border-collapse:collapse;min-width:700px;"><thead><tr style="background:#f8fafc;"><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">NP</th><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Cliente</th><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Resp.</th><th style="padding:10px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Vencimento</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Valor Total</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">MRR</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">ARR</th></tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-116809</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">Randon SA Implementos e Participações</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jan/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 276.312,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 23.026,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-116808</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">RODOBENS</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Dez/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 103.645,28</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.566,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 84.853,28</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115073</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">WAY DATA SOLUTION S/A</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jan/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.930,46</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 2.930,46</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115070</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">VANTIX TECNOLOGIA COMÉRCIO E SERVIÇOS DE INFORMÁTICA LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 11.001,77</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 11.001,77</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115068</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">USINA SANTA ISABEL</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Fev/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 17.220,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.435,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115066</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">UNIMED VALES DO TAQUARI E RIO PARDO LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Fev/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 38.120,85</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 38.120,85</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115065</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">UNIMED PORTO ALEGRE</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mar/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 132.818,66</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 11.068,22</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115054</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SOTRAN LOGÍSTICA E TRANSPORTE</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 66.993,34</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.313,27</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 15.234,10</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115048</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SEPROL</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jan/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 8.955,24</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 746,27</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115046</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SENAC RJ</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Fev/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 46.440,53</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 46.440,53</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115044</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SCGAS - COMPANHIA DE GAS DE SANTA CATARINA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mar/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.351,36</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 7.351,36</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115043</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SAQUE PAGUE</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Fev/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 60.982,84</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 5.081,90</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115042</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">Sapore</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mar/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 178.403,92</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 14.866,99</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115040</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SANTA CASA DE MISERICÓRDIA DE PORTO ALEGRE</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mar/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.646,90</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 3.646,90</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115038</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SAFEWEB</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 133.565,79</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 11.130,48</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115037</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SABEMI SEGURADORA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Fev/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 23.085,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.923,80</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115033</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">RESERVA BRASILEIRA INDUSTRIA E COMERCIO LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Abr/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 22.804,08</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.900,34</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115027</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">PLANSERVI ENGENHARIA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Fev/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 4.909,09</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 4.909,09</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115026</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">Pestana Leilões</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.692,90</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 7.692,90</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115024</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">PANATLANTICA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.489,43</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 290,78</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115022</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">OCYAN</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jan/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 9.176,64</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 9.176,64</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115012</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">LOJAS COLOMBO S/A</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 8.538,28</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 711,52</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115001</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">INTERCITY</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jan/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 41.088,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.424,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-115000</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">INSTITUTO FALCAO BAUER DA QUALIDADE</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Abr/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 16.979,65</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 929,72</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 5.823,01</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114999</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">INOVATECH SOLUÇÕES EM INFORMÁTICA LTDA - EPP</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 4.144,36</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 4.144,36</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114993</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">HOSPITAL MAE DE DEUS (AESC)</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jul/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 98.947,56</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 8.245,63</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114991</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">HOSPITAL CARE</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jun/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 312.940,69</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 30.705,52</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114983</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">GOLDEN TECHNOLOGIA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 22.773,48</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.897,79</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114982</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">GGT SOLUÇÃO TECNOLOGICAS LTDA (ANGOLAPREV)</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mar/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 54.105,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 54.105,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114977</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">FLOWTI</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jun/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 50.601,72</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 4.216,81</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114972</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">EQUALITI E SOLUCOES EM TI LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Abr/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.949,99</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 2.949,99</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114968</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">COTRIBÁ</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mar/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.485,48</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 623,79</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114965</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">CONSTRUTORA MARQUISE</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 1.584,62</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 1.584,62</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114956</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">CALÇADOS BEIRA RIO</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jan/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 9.062,78</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 9.062,78</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114953</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">BRASKEM</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Abr/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 32.400,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.700,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114949</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">AUXILIADORA PREDIAL</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mar/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 412.288,08</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 34.357,34</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#059669;">NP-114943</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Dez/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 237.043,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 19.752,92</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#f0fdf4;border-top:2px solid #bbf7d0;"><td colspan="4" style="padding:9px 14px;font-size:11px;font-weight:800;text-transform:uppercase;color:#059669;">Total · 37 contratos</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#111827;">R$ 2.472.478,77</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#7c3aed;">R$ 184.914,09</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#0891b2;">R$ 309.027,64</td></tr></tbody></table></div>
  </div>

  <!-- PF -->
  <div style="margin-bottom:24px;">
    <div class="p26-section-label">💜 Processo Financeiro</div>
    <div style="overflow-x:auto;border:1px solid #e9d5ff;border-radius:12px;"><table style="width:100%;border-collapse:collapse;min-width:700px;"><thead><tr style="background:#f8fafc;"><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">NP</th><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Cliente</th><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Resp.</th><th style="padding:10px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Vencimento</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Valor Total</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">MRR</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">ARR</th></tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#7c3aed;">NP-115078</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">CONNECTION SEGURANÇA E GESTÃO DE TI</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Ago/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 17.635,19</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 994,29</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 6.536,95</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#7c3aed;">NP-115076</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">FORNO DE MINAS</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jan/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 777,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 777,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#7c3aed;">NP-115047</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SEPHORA DO BRASIL PARTICIPAÇÕES S.A.</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Dez/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 19.190,76</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.599,23</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#7c3aed;">NP-114998</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">INCORP TECHNOLOGY INFORMATICA LTDA - EPP</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Fev/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 6.388,02</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 6.388,02</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#7c3aed;">NP-114978</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">FORSALES MECANET</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jul/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 16.797,84</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.399,82</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#7c3aed;">NP-114944</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">ASSOCIACAO HOSPITALAR MOINHOS DE VENTO</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mar/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 45.084,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.757,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#f5f3ff;border-top:2px solid #e9d5ff;"><td colspan="4" style="padding:9px 14px;font-size:11px;font-weight:800;text-transform:uppercase;color:#7c3aed;">Total · 6 contratos</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#111827;">R$ 105.872,81</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#7c3aed;">R$ 7.750,34</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#0891b2;">R$ 13.701,97</td></tr></tbody></table></div>
  </div>

  <!-- Em análise -->
  <div style="margin-bottom:24px;">
    <div class="p26-section-label">🔵 Em Análise pelo Cliente</div>
    <div style="overflow-x:auto;border:1px solid #bfdbfe;border-radius:12px;"><table style="width:100%;border-collapse:collapse;min-width:800px;"><thead><tr style="background:#f8fafc;"><th style="padding:10px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Prazo</th><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">NP</th><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Cliente</th><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Resp.</th><th style="padding:10px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Vencimento</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Valor Total</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">MRR</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">ARR</th></tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:3px 10px;border-radius:99px;white-space:nowrap;">🔴 73 dias atrás</span></td><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#2563eb;">NP-115702</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">Argenta Participacoes LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 47.856,60</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.988,05</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:11px;font-weight:700;padding:3px 10px;border-radius:99px;white-space:nowrap;">🟢 vence em 12 dias</span></td><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#2563eb;">NP-115077</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">NETCENTER INFORMATICA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jul/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.254,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 2.254,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:11px;font-weight:700;padding:3px 10px;border-radius:99px;white-space:nowrap;">🟢 vence em 19 dias</span></td><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#2563eb;">NP-115071</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">VERZANI & SANDRINI LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Ago/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.231,60</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 2.231,60</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:11px;font-weight:700;padding:3px 10px;border-radius:99px;white-space:nowrap;">🟢 vence em 80 dias</span></td><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#2563eb;">NP-115063</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">Trt Da 4ª Região</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Out/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 78.738,72</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 6.561,56</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:3px 10px;border-radius:99px;white-space:nowrap;">🔴 193 dias atrás</span></td><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#2563eb;">NP-115057</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">TECCLOUD SERVICOS DE TECNOLOGIA AHU LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Anderson</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jan/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 13.500,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 13.500,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:11px;font-weight:700;padding:3px 10px;border-radius:99px;white-space:nowrap;">🟢 vence em 19 dias</span></td><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#2563eb;">NP-115055</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">STEFANINI</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Ago/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 71.022,60</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 5.918,55</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:3px 10px;border-radius:99px;white-space:nowrap;">🔴 103 dias atrás</span></td><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#2563eb;">NP-115039</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SANTA CASA DE MISERICORDIA DA BAHIA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Anderson</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Abr/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 14.196,96</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.183,08</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:3px 10px;border-radius:99px;white-space:nowrap;">🔴 73 dias atrás</span></td><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#2563eb;">NP-115036</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">S3CURITY</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Anderson</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Mai/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.530,69</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 7.530,69</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:9px 14px;text-align:center;"><span style="background:#dcfce7;color:#166534;font-size:11px;font-weight:700;padding:3px 10px;border-radius:99px;white-space:nowrap;">🟢 vence em 12 dias</span></td><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#2563eb;">NP-114986</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">GRPCOM GRUPO PARANAENSE DE COMUNICAÇÃO</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;font-size:11px;font-weight:600;color:#059669;">Jul/26</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 82.428,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 6.869,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#f8fafc;border-top:1px solid #e5e7eb;"><td colspan="8" style="padding:8px 14px;font-size:11px;color:#6b7280;"><span style="margin-right:16px;">🔴 <strong>4</strong> · &gt;60 dias</span><span style="margin-right:16px;">🟡 <strong>0</strong> · 31–60 dias</span><span>🟢 <strong>5</strong> · ≤30 dias ou futuro</span></td></tr><tr style="background:#eff6ff;border-top:2px solid #bfdbfe;"><td colspan="5" style="padding:9px 14px;font-size:11px;font-weight:800;text-transform:uppercase;color:#2563eb;">Total · 9 contratos</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#111827;">R$ 319.759,17</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#7c3aed;">R$ 24.520,24</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#0891b2;">R$ 25.516,29</td></tr></tbody></table></div>
  </div>
  ...
  <div style="margin-bottom:24px;">
    ...
    <div style="overflow-x:auto;border:1px solid #e5e7eb;border-radius:12px;"><table style="width:100%;border-collapse:collapse;"><thead><tr style="background:#f8fafc;"><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Vencimento</th><th style="padding:10px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Contratos</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Valor Total</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">MRR</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">ARR</th></tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Fev/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">1</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 2.052,45</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;">R$ 2.052,45</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Abr/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">2</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 48.199,32</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;">R$ 4.016,61</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Mai/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">1</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 43.249,84</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;">R$ 1.677,32</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;">R$ 23.122,00</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jun/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">2</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 32.020,04</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;">R$ 932,17</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;">R$ 20.834,00</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Jul/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">3</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 210.965,46</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;">R$ 17.423,33</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;">R$ 1.885,50</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Ago/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">19</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 919.089,16</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;">R$ 68.238,27</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;">R$ 100.229,92</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Set/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">14</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 745.616,84</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;">R$ 40.609,30</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;">R$ 258.305,20</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Out/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">17</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 1.286.717,53</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;">R$ 120.862,50</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;">R$ 41.347,81</td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Nov/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">7</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 409.640,25</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;">R$ 26.447,00</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;">R$ 93.658,59</td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 16px;font-size:13px;font-weight:700;color:#111827;">Dez/26</td><td style="padding:10px 16px;text-align:center;"><span style="background:#f0f2f5;color:#374151;font-size:12px;font-weight:700;padding:3px 12px;border-radius:99px;">16</span></td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#111827;">R$ 901.949,91</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#7c3aed;">R$ 68.008,38</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:700;color:#0891b2;">R$ 85.848,71</td></tr><tr style="background:#f8fafc;border-top:2px solid #e5e7eb;"><td style="padding:10px 16px;font-size:11px;font-weight:800;text-transform:uppercase;color:#374151;">Total · 10 meses</td><td style="padding:10px 16px;text-align:center;font-size:13px;font-weight:800;color:#374151;">82</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:800;color:#111827;">R$ 4.599.500,80</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:800;color:#7c3aed;">R$ 348.214,88</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:800;color:#0891b2;">R$ 627.284,18</td></tr></tbody></table></div>
  </div>
  ...
  <div style="margin-bottom:24px;">
    ...
    <div style="overflow-x:auto;border:1px solid #fde68a;border-radius:12px;"><table style="width:100%;border-collapse:collapse;min-width:600px;"><thead><tr style="background:#fef9c3;"><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">NP</th><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Cliente</th><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Resp.</th><th style="padding:10px 16px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">Mês Redução</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">▼ MRR</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;white-space:nowrap;">▼ ARR</th></tr></thead><tbody><tr style="background:#ffffff;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-116807</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">RODOBENS NEGÓCIOS IMOBILIÁRIOS</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Jan/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 30.236,58</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.242,10</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 3.331,38</td></tr><tr style="background:#fef2f2;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-116093</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">SYNERGIE SISTEMAS LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Anderson</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Jan/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 41.899,68</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 3.491,64</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-116076</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">NOURYON PULP AND PERFORMANCE INDUSTRIA QUIMICA LTDA</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Jan/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 30.500,16</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.541,68</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fef2f2;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-116075</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">ASSOCIAÇÃO ANTÔNIO VEIRA JESUÍTA DO BRASIL (ASAV)</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Anderson</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Jan/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 28.993,68</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 2.416,14</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-115004</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">J&M SOLUÇÕES EM TECNOLOGIA EIRELI (AlliedIT)</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Fev/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 3.189,60</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 265,80</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fef2f2;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-115002</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">INTERSISTEMAS INFORMATICA LTDA - NETLOGIC</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Denise</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Jun/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.416,63</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 618,05</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-114995</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">IGUATEMI EMPRESA DE SHOPPING CENTERS S/A</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Abr/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 85.696,80</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 7.141,40</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fef2f2;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-114994</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">HT SOLUTIONS</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Pedro</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Jan/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 2.220,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 185,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-114990</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">GTFOODS GROUP</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Anderson</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Jan/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 14.240,00</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;"><span style="color:#d1d5db;">—</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;">R$ 14.240,00</td></tr><tr style="background:#fef2f2;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-114988</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">Grupo Orcali</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Anderson</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Abr/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 22.757,52</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 1.896,46</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #fecaca;"><td style="padding:9px 14px;font-family:monospace;text-align:left;font-size:11px;font-weight:600;color:#dc2626;">NP-114962</td><td style="padding:9px 14px;text-align:left;font-size:12px;font-weight:600;color:#111827;">CLAMPER</td><td style="padding:9px 14px;text-align:left;font-size:11px;font-weight:600;color:#6b7280;">Anderson</td><td style="padding:9px 14px;text-align:center;"><span style="background:#fee2e2;color:#dc2626;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">Jan/26</span></td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#111827;">R$ 7.109,28</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#7c3aed;">R$ 592,44</td><td style="padding:9px 14px;text-align:right;font-size:12px;font-weight:700;color:#0891b2;"><span style="color:#d1d5db;">—</span></td></tr><tr style="background:#fef2f2;border-top:2px solid #fecaca;"><td colspan="4" style="padding:9px 14px;font-size:11px;font-weight:800;text-transform:uppercase;color:#dc2626;">Total · 11 contratos cancelados</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#111827;">R$ 274.259,93</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#7c3aed;">R$ 21.390,71</td><td style="padding:9px 14px;text-align:right;font-size:13px;font-weight:800;color:#0891b2;">R$ 17.571,38</td></tr></tbody></table></div>
  </div>

  <class="p26-meta">
    Fonte: Renovação de Contratos · <strong>Atualizado em 13/07/2026</strong>
  </div>
