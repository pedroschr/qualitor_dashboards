export default {
  async fetch(request,env){
    const SENHA="Qualitor!@#25",COOKIE="qlt_auth",TOKEN="qualitor2026ok";
    const url=new URL(request.url),cookies=request.headers.get("Cookie")||"";
    const auth=cookies.includes(COOKIE+"="+TOKEN);
    if(request.method==="POST"&&url.pathname==="/login"){
      const body=await request.formData(),senha=body.get("senha")||"";
      if(senha===SENHA)return new Response("",{status:302,headers:{"Location":"/","Set-Cookie":COOKIE+"="+TOKEN+"; Path=/; HttpOnly; Secure; SameSite=Strict; Max-Age=28800"}});
      return new Response(loginHTML("Senha incorreta."),{status:401,headers:{"Content-Type":"text/html; charset=utf-8"}});
    }
    if(url.pathname==="/logout")return new Response("",{status:302,headers:{"Location":"/","Set-Cookie":COOKIE+"=; Path=/; Max-Age=0"}});
    if(!auth)return new Response(loginHTML(""),{status:200,headers:{"Content-Type":"text/html; charset=utf-8"}});
...
<div class="p26-page">
  ...
  <div style="background:#fff;border:1px solid var(--border);border-radius:16px;overflow:hidden;">
    <div style="display:flex;justify-content:space-between;align-items:center;padding:18px 20px 14px;border-bottom:1px solid var(--border);">
      <div><div style="font-size:13px;font-weight:700;color:#111827;">Aprovados ≥ Jan / 2026</div>
      <div style="font-size:12px;color:#6b7280;margin-top:2px;">15 projetos · ordenado por data de aprovação</div></div>
...
<div class="kpi-row" style="margin-bottom:16px;"><div class="kpi-card" style="--card-accent:#2563eb;"><div class="kpi-icon">📅</div><div class="kpi-label">Carteira Jan/2026</div><div class="kpi-value">143</div><div class="kpi-sub">R$ 7.068.386,59</div></div><div class="kpi-card" style="--card-accent:#059669;"><div class="kpi-icon">📋</div><div class="kpi-label">Carteira Atual</div><div class="kpi-value">135</div><div class="kpi-sub">Mar/2026 · excl. cancelados</div></div><div class="kpi-card" style="--card-accent:#dc2626;"><div class="kpi-icon">✖</div><div class="kpi-label">Contratos Cancelados</div><div class="kpi-value">8</div><div class="kpi-sub"><span style="color:#dc2626;">5.6% do total da carteira</span></div></div><div class="kpi-card" style="--card-accent:#059669;"><div class="kpi-icon">✅</div><div class="kpi-label">Renovados</div><div class="kpi-value">9</div><div class="kpi-sub"><span style="color:#059669;">6.3% já concluídos</span></div></div></div>
<div class="kpi-row" style="margin-bottom:28px;"><div class="kpi-card" style="--card-accent:#2563eb;"><div class="kpi-icon">📅</div><div class="kpi-label">Carteira Jan/2026</div><div class="kpi-value">R$ 7,07M</div><div class="kpi-sub">Valor bruto · incl. cancelados · base 2026</div></div><div class="kpi-card" style="--card-accent:#2563eb;"><div class="kpi-icon">💰</div><div class="kpi-label">Carteira Atual</div><div class="kpi-value">R$ 6,89M</div><div class="kpi-sub">Valor líquido · 135 contratos ativos</div></div><div class="kpi-card" style="--card-accent:#dc2626;"><div class="kpi-icon">📉</div><div class="kpi-label">Redução da Carteira</div><div class="kpi-value"><span style="color:#dc2626;">−R$ 178,9K</span></div><div class="kpi-sub"><span style="color:#dc2626;">−2.5% vs início do ano</span></div></div><div class="kpi-card" style="--card-accent:#7c3aed;"><div class="kpi-icon">🎯</div><div class="kpi-label">Ticket Médio</div><div class="kpi-value">R$ 51,0K</div><div class="kpi-sub">Valor médio por contrato · R$ 51.033,04</div></div></div>
<div class="card" style="margin-bottom:20px;">
  <div class="card-header"><div><div class="card-title">Receita Recorrente Mensal (MRR)</div><div class="card-subtitle">Receita mensal recorrente por mês de vencimento · Jan–Dez/2026</div></div></div>
  <div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">
    <thead><tr style="background:#f8fafc;"><th style="padding:10px 14px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;">Mês</th><th style="padding:10px 14px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;">Contratos</th><th style="padding:10px 14px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#7c3aed;border-bottom:1px solid #e5e7eb;">MRR (c/ cancelados)</th><th style="padding:10px 14px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#059669;border-bottom:1px solid #e5e7eb;">MRR Líquido</th><th style="padding:10px 14px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#dc2626;border-bottom:1px solid #e5e7eb;">Variação</th></tr></thead>
    <tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Jan/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">6</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 24.866,29</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 19.908,47</td><td style="padding:10px 14px;text-align:right;"><span style="color:#dc2626;font-weight:600;">▼ R$ 4.957,82</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Fev/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">4</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 9.058,75</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 9.058,75</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Mar/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">5</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 63.567,12</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 63.567,12</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Abr/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">4</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 7.899,69</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 7.899,69</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Mai/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">6</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 19.303,90</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 19.303,90</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Jun/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">4</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 31.894,74</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 31.894,74</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Jul/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">9</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 44.356,75</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 43.764,31</td><td style="padding:10px 14px;text-align:right;"><span style="color:#dc2626;font-weight:600;">▼ R$ 592,44</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Ago/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">20</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 86.143,86</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 83.981,60</td><td style="padding:10px 14px;text-align:right;"><span style="color:#dc2626;font-weight:600;">▼ R$ 2.162,26</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Set/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">8</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 41.493,30</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 41.493,30</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Out/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">13</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 80.757,24</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 77.265,60</td><td style="padding:10px 14px;text-align:right;"><span style="color:#dc2626;font-weight:600;">▼ R$ 3.491,64</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Nov/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">5</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 26.447,00</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 26.447,00</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Dez/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">11</td><td style="padding:10px 14px;text-align:right;color:#7c3aed;font-weight:600;">R$ 73.156,04</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 70.913,94</td><td style="padding:10px 14px;text-align:right;"><span style="color:#dc2626;font-weight:600;">▼ R$ 2.242,10</span></td></tr><tr style="background:#f8fafc;border-top:2px solid #e5e7eb;font-weight:800;"><td style="padding:11px 14px;color:#111827;">TOTAL</td><td style="padding:11px 14px;"></td><td style="padding:11px 14px;text-align:right;color:#7c3aed;">R$ 508.944,68</td><td style="padding:11px 14px;text-align:right;color:#059669;">R$ 495.498,42</td><td style="padding:11px 14px;text-align:right;color:#dc2626;">R$ -13.446,26 (-2.6%)</td></tr></tbody>
  </table></div>
</div>
<div class="card" style="margin-bottom:20px;">
  <div class="card-header"><div><div class="card-title">Receita Anual Recorrente (ARR)</div><div class="card-subtitle">Receita anual recorrente por mês de vencimento · Jan–Dez/2026</div></div></div>
  <div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">
    <thead><tr style="background:#f8fafc;"><th style="padding:10px 14px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;">Mês</th><th style="padding:10px 14px;text-align:center;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;">Contratos</th><th style="padding:10px 14px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#0891b2;border-bottom:1px solid #e5e7eb;">ARR (c/ cancelados)</th><th style="padding:10px 14px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#059669;border-bottom:1px solid #e5e7eb;">ARR Líquido</th><th style="padding:10px 14px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#dc2626;border-bottom:1px solid #e5e7eb;">Variação</th></tr></thead>
    <tbody><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Jan/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">5</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 28.524,24</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 28.524,24</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Fev/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">4</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 51.470,41</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 51.470,41</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Mar/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">4</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 78.783,55</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 64.543,55</td><td style="padding:10px 14px;text-align:right;"><span style="color:#dc2626;font-weight:600;">▼ R$ 14.240,00</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Abr/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">1</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 2.832,72</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 2.832,72</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Mai/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">6</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 100.791,52</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 100.791,52</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Jul/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">2</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 12.079,50</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 12.079,50</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Ago/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">8</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 195.123,91</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 195.123,91</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Set/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">9</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 223.822,51</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 223.822,51</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Out/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">7</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 44.679,19</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 44.679,19</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#ffffff;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Nov/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">2</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 93.658,59</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 93.658,59</td><td style="padding:10px 14px;text-align:right;"><span style="color:#94a3b8;">—</span></td></tr><tr style="background:#fafafa;border-bottom:1px solid #f3f4f6;"><td style="padding:10px 14px;font-weight:600;color:#111827;">Dez/2026</td><td style="padding:10px 14px;text-align:center;color:#6b7280;">11</td><td style="padding:10px 14px;text-align:right;color:#0891b2;font-weight:600;">R$ 108.444,29</td><td style="padding:10px 14px;text-align:right;color:#059669;font-weight:600;">R$ 105.112,91</td><td style="padding:10px 14px;text-align:right;"><span style="color:#dc2626;font-weight:600;">▼ R$ 3.331,38</span></td></tr><tr style="background:#f8fafc;border-top:2px solid #e5e7eb;font-weight:800;"><td style="padding:11px 14px;color:#111827;">TOTAL</td><td style="padding:11px 14px;"></td><td style="padding:11px 14px;text-align:right;color:#0891b2;">R$ 940.210,43</td><td style="padding:11px 14px;text-align:right;color:#059669;">R$ 922.639,05</td><td style="padding:11px 14px;text-align:right;color:#dc2626;">R$ -17.571,38 (-1.9%)</td></tr></tbody>
  </table></div>
</div>
<div class="card" style="margin-bottom:20px;">
  <div class="card-header"><div><div class="card-title">Impacto dos Cancelamentos</div><div class="card-subtitle">Comparativo: carteira original vs. carteira atual (sem cancelados)</div></div><span style="background:#fee2e2;color:#991b1b;font-size:11px;font-weight:700;padding:4px 12px;border-radius:99px;">8 cancelados</span></div>
  <div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">
    <thead><tr style="background:#f8fafc;"><th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;">Indicador</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;">Carteira Original</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#9ca3af;border-bottom:1px solid #e5e7eb;">Carteira Atual</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#dc2626;border-bottom:1px solid #e5e7eb;">Queda</th><th style="padding:10px 16px;text-align:right;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#dc2626;border-bottom:1px solid #e5e7eb;">%</th></tr></thead>
    <tbody><tr style="border-bottom:1px solid #f3f4f6;"><td style="padding:11px 16px;color:#111827;">Contratos</td><td style="padding:11px 16px;text-align:right;color:#6b7280;">R$ 143,00</td><td style="padding:11px 16px;text-align:right;color:#059669;font-weight:600;">R$ 135,00</td><td style="padding:11px 16px;text-align:right;color:#dc2626;font-weight:700;">▼ R$ 8,00</td><td style="padding:11px 16px;text-align:right;color:#dc2626;font-weight:700;">5.6%</td></tr><tr style="border-bottom:1px solid #f3f4f6;"><td style="padding:11px 16px;color:#111827;">Valor Total</td><td style="padding:11px 16px;text-align:right;color:#6b7280;">R$ 7.068.386,59</td><td style="padding:11px 16px;text-align:right;color:#059669;font-weight:600;">R$ 6.889.460,09</td><td style="padding:11px 16px;text-align:right;color:#dc2626;font-weight:700;">▼ R$ 178.926,50</td><td style="padding:11px 16px;text-align:right;color:#dc2626;font-weight:700;">2.5%</td></tr><tr style="border-bottom:1px solid #f3f4f6;"><td style="padding:11px 16px;color:#111827;">MRR</td><td style="padding:11px 16px;text-align:right;color:#6b7280;">R$ 508.944,68</td><td style="padding:11px 16px;text-align:right;color:#059669;font-weight:600;">R$ 495.498,42</td><td style="padding:11px 16px;text-align:right;color:#dc2626;font-weight:700;">▼ R$ 13.446,26</td><td style="padding:11px 16px;text-align:right;color:#dc2626;font-weight:700;">2.6%</td></tr><tr style="border-bottom:1px solid #f3f4f6;"><td style="padding:11px 16px;color:#111827;">ARR</td><td style="padding:11px 16px;text-align:right;color:#6b7280;">R$ 940.210,43</td><td style="padding:11px 16px;text-align:right;color:#059669;font-weight:600;">R$ 922.639,05</td><td style="padding:11px 16px;text-align:right;color:#dc2626;font-weight:700;">▼ R$ 17.571,38</td><td style="padding:11px 16px;text-align:right;color:#dc2626;font-weight:700;">1.9%</td></tr></tbody>
  </table></div>
</div>
...
<div class="page">
  ...
  <div class="card">
    <div class="card-header"><div><div class="card-title">Registro de Atualizações</div></div></div>
    <p style="padding:20px;color:var(--muted);font-size:13px;">Histórico de snapshots e correções aplicadas ao dashboard.</p>
  </div>
</div>
